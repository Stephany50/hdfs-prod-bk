...
JOIN
(SELECT * FROM TMP.TT_bdi_1A where not(msisdn is null or trim(msisdn) = '')) b ON FN_FORMAT_MSISDN_TO_9DIGITS(trim(c.MSISDN_s)) = FN_FORMAT_MSISDN_TO_9DIGITS(trim(b.MSISDN))