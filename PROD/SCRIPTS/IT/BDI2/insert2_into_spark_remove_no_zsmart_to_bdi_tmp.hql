INSERT INTO TMP.TT_BDI_TMP1_1A
SELECT
MSISDN,
(case
...
FROM (select * from TMP.TT_BDI_TMP_1A where not(msisdn is null or trim(msisdn) = '')) A
left join
(SELECT
...
FROM MON.SPARK_FT_MSISDN_IMEI_LOCALISATION_TO_BDI WHERE EVENT_DATE='2020-12-07'
