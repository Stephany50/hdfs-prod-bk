INSERT INTO CDR.SPARK_IT_ZEBRA_MASTER PARTITION (TRANSACTION_DATE,FILE_DATE)
SELECT
	CHANNEL_USER_ID	,
	PARENT_USER_ID	,
	OWNER_USER_ID	,
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_ZEBRA_MASTER WHERE TRANSACTION_DATE BETWEEN DATE_SUB(CURRENT_DATE,${hivevar:date_offset}) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
