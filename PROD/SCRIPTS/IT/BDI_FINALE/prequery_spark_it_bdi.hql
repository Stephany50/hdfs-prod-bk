...
J.ZSMART_SIZE_IS_OK>3800000000 AND K.hlr_nb_file_is_ok=6 AND L.IT_BDI_TMP_EXITE>0 AND M.PREV_IT_BDI_PERS_MORALE_EXIST>0
AND tmp_bdi_prev.PREV_SPARK_IT_BDI_TMP_EXIST >=10 AND tmp_bdi.SPARK_IT_BDI_TMP_EXIST = 0,"OK","NOK") FROM
...
--(SELECT COUNT(*) FT_MSISDN_IMEI_LOCALISATION_TO_BDI_EXISTS FROM MON.SPARK_FT_MSISDN_IMEI_LOCALISATION_TO_BDI WHERE EVENT_DATE='###SLICE_VALUE###') H,
