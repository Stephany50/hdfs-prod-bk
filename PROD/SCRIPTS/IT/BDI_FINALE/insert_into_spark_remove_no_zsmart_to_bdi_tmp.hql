...
WHERE original_file_date = '2020-03-13') zmart 
...
FROM MON.SPARK_FT_MSISDN_IMEI_LOCALISATION_TO_BDI) B 
ON(SUBSTRING(TRIM(A.MSISDN),-9,9)=SUBSTRING(TRIM(B.MSISDN),-9,9))
) T;