...
from
CDR.tt_bdi_crm_b2c C
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.spark_it_bdi_crm_b2c where  ORIGINAL_FILE_DATE BETWEEN DATE_SUB(CURRENT_DATE,2) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
