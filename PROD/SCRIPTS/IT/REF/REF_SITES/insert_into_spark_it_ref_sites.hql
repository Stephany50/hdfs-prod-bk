...
SELECT
 (CASE WHEN LAC like '%N/A%' THEN null ELSE LAC END) ,
 ...
 (CASE WHEN tower_height like '%N/A%' THEN null ELSE tower_height END) towerheight,
 (CASE WHEN date_mad_site like '%N/A%' THEN null ELSE date_mad_site END) datemad,
 (CASE WHEN date_met_site like '%N/A%' THEN null ELSE date_met_site END) datemet,
 (CASE WHEN date_arret_site like '%N/A%' THEN null ELSE date_arret_site END) datearret,
 ...
 (CASE WHEN expiration__bail like '%N/A%' THEN null ELSE expiration__bail END) expirationbail,
