CREATE TABLE CDR.SPARK_IT_ZTE_SUBSCRIPTION (
  ACC_NBR VARCHAR(16),
  CHANNEL_ID  INT,
  SUBS_EVENT_ID  INT,
...
-- UNKNOWN_COL,
ALTER TABLE CDR.SPARK_IT_ZTE_SUBSCRIPTION ADD COLUMNS (UNKNOWN_COL VARCHAR(200));

-- ACCOUNT_RES_ID,
ALTER TABLE CDR.SPARK_IT_ZTE_SUBSCRIPTION ADD COLUMNS (ACCOUNT_RES_ID VARCHAR(200));

-- REQUEST_ID
ALTER TABLE CDR.SPARK_IT_ZTE_SUBSCRIPTION ADD COLUMNS (REQUEST_ID VARCHAR(200));
...
ALTER TABLE CDR.SPARK_IT_ZTE_SUBSCRIPTION ADD COLUMNS (EVENT_COST_CHAR VARCHAR(200));
...
ALTER TABLE CDR.SPARK_IT_ZTE_SUBSCRIPTION ADD COLUMNS (EVENT_COST_SUM DECIMAL(17,3));
