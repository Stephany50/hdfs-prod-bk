INSERT INTO CDR.SPARK_IT_ZTE_CHECK_FILE_ALL PARTITION(FILE_DATE)
SELECT
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_ZTE_CHECK_FILE_ALL WHERE FILE_DATE BETWEEN DATE_SUB(CURRENT_DATE,${hivevar:date_offset}) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
