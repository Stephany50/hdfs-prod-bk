INSERT INTO CDR.SPARK_IT_ZTE_CHECK_FILE PARTITION(CDR_DATE,FILE_DATE)
SELECT
 CDR_NAME,
 ( CASE 
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_ZTE_CHECK_FILE WHERE CDR_DATE BETWEEN DATE_SUB(CURRENT_DATE,3) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
