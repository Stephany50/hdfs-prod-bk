CREATE TABLE CDR.SPARK_IT_ZTE_DATA_POST (
...
CLUSTERED BY(PRICE_PLAN_CODE,ACCT_ITEM_TYPE_ID1,ACCT_ITEM_TYPE_ID2,ACCT_ITEM_TYPE_ID3,ACCT_ITEM_TYPE_ID4,PROD_SPEC_ID,RATING_GROUP,RE_ID,BILLING_NBR) INTO 16 BUCKETS
