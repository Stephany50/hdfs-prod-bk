INSERT INTO CDR.SPARK_IT_ZTE_RECURRING PARTITION (EVENT_DATE,FILE_DATE)
SELECT
ACC_NBR,
...
LEFT JOIN (SELECT DISTINCT ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_ZTE_RECURRING WHERE EVENT_DATE BETWEEN DATE_SUB(CURRENT_DATE,${hivevar:date_offset}) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
