INSERT INTO TMP.TT_KYC_PERS_PHY_B2C_FLOTTE
SELECT
...
FROM (select * from CDR.SPARK_IT_BDI_FULL where original_file_date=DATE_SUB('###SLICE_VALUE###',1) and not(msisdn is null or trim(msisdn) = '')) A
FULL OUTER JOIN
