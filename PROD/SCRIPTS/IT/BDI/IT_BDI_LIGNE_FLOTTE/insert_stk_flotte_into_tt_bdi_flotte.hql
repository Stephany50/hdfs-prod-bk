...
JOIN
(SELECT * FROM TMP.TT_KYC_PERS_PHYSIQUE_B2C_FLOTTE where not(msisdn is null or trim(msisdn) = '')) b ON FN_FORMAT_MSISDN_TO_9DIGITS(trim(c.MSISDN_s)) = FN_FORMAT_MSISDN_TO_9DIGITS(trim(b.MSISDN))