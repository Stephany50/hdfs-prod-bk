-- cette table contient les personnes physiques majeurs, mineurs et PP, 
-- qui serviront plutard dans le calcul de la FT_BDI.
...
)COMMENT 'CDR.SPARK_IT_BDI'
PARTITIONED BY (ORIGINAL_FILE_DATE DATE)
STORED AS PARQUET TBLPROPERTIES ('PARQUET.COMPRESS'='SNAPPY');



CREATE TABLE TMP.SPARK_IT_BDI (
GUID   varchar(255),
MSISDN   varchar(255),
TYPE_PERSONNE   varchar(255),
NOM_PRENOM   varchar(255),
