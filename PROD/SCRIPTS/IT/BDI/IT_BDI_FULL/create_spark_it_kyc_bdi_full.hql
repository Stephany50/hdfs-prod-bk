-- Cette table contient l'ensemble des lignes identifiées : personnes physiques (majeurs, mineurs, PP) 
-- et personnes morales utilisateur de flotte et M2M.
CREATE TABLE CDR.SPARK_IT_KYC_BDI_FULL(
   guid string,
   cust_guid string,           
   msisdn string,                                 
   ...
   imei string,
   odbincomingcalls string,
   odboutgoingcalls string,
   statut_hlr string,                                 
...
---- table de test
CREATE TABLE TMP.SPARK_IT_BDI_FULL(
   guid string,          
   msisdn string,                                 
   type_personne string,                          
   nom_prenom string,                             
