...
(case when length(trim(nvl(ADRESSE_STRUCTURE,''))) = 0 then trim(VILLE_STRUCTURE)||"  "||trim(QUARTIER_STRUCTURE) else ADRESSE_STRUCTURE end)  AS ADRESSE_STRUCTURE,
...
from TMP.TT_KYC_PERS_MORALE_B2B
) pm