INSERT INTO CDR.SPARK_IT_KYC_CRM_B2C
select
guid,
msisdn,
null type_personne,
...
from
TMP.TT_KYC_CRM_B2C C
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_KYC_CRM_B2C where  ORIGINAL_FILE_DATE BETWEEN DATE_SUB(CURRENT_DATE,2) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
