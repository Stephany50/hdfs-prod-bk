INSERT INTO CDR.IT_OMNY_BalanceSubscribers PARTITION (ORIGINAL_FILE_DATE)
SELECT
ORIGINAL_FILE_NAME         ,
ORIGINAL_FILE_SIZE         ,
...
LEFT JOIN (SELECT DISTINCT original_file_name FILE_NAME FROM CDR.IT_OMNY_BalanceSubscribers) T ON T.file_name = C.original_file_name
