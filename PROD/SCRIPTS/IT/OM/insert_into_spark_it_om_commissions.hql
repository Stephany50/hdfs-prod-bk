INSERT INTO CDR.SPARK_IT_OM_COMMISSIONS PARTITION (TRANSACTION_DATE,FILE_DATE)
SELECT
	TRANSACTION_ID,
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_OM_COMMISSIONS WHERE TRANSACTION_DATE BETWEEN DATE_SUB(CURRENT_DATE,3) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
