...
TRANSFER_ID,
SERVICE_TYPE,
MODIFIED_ON AS LAST_TRANSACTION,
CURRENT_TIMESTAMP AS INSERT_DATE,
A1.CREATION_DATE AS EVENT_DATE
FROM
      (
      (SELECT A1.MSISDN AS MSISDN, A1.USER_ID AS USER_ID, A1.CREATION_DATE AS CREATION_DATE,A1.USER_TYPE AS USER_TYPE,
      A1.MODIFIED_ON AS MODIFIED_ON,A1.FIRST_TRANSACTION_ON, B1.TRANSFER_ID AS TRANSFER_ID, B1.SERVICE_TYPE AS SERVICE_TYPE,B1.MODIFIED_ON AS LAST_TRANSACTION,
      ...
      A2.MODIFIED_ON AS MODIFIED_ON,A2.FIRST_TRANSACTION_ON, B2.TRANSFER_ID AS TRANSFER_ID, B2.SERVICE_TYPE AS SERVICE_TYPE,B2.MODIFIED_ON AS LAST_TRANSACTION,
      ...
      INNER JOIN CDR.SPARK_IT_OMNY_TRANSACTIONS B2 ON A2.MSISDN = B2.RECEIVER_MSISDN)
      ) C
ORDER BY C.MSISDN