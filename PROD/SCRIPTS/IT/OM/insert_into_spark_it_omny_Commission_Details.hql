INSERT INTO CDR.SPARK_IT_OMNY_COMMISSION_DETAILS
SELECT
	TRANSACTION_ID,
...
FROM CDR.TT_OMNY_COMMISSION_DETAILS C
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_OMNY_COMMISSION_DETAILS WHERE TRANSACTION_DATE BETWEEN DATE_SUB(CURRENT_DATE,3) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
