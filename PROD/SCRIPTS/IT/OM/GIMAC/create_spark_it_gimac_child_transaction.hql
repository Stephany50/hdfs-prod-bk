...
CREATE TABLE MON.SQ_IT_GIMAC_CHILD_TRANS (
    CT_ID VARCHAR(250),
    CT_TYPE VARCHAR(250),
    CT_FROM_MSISDN VARCHAR(250),
    CT_TO_MSISDN VARCHAR(250),
...
CREATE TABLE TMP.SQ_IT_GIMAC_CHILD_TRANS (
    CT_ID VARCHAR(250),
    CT_TYPE VARCHAR(250),
    CT_FROM_MSISDN VARCHAR(250),
    CT_TO_MSISDN VARCHAR(250),
...
BEGIN 
  SAMPLE_TABLE := 'MON.SQ_IT_GIMAC_CHILD_TRANS';
  MIN_DATE_PARTITION := '20230101';
  MAX_DATE_PARTITION := '20260101';
  KEY_COLUMN_PART_NAME := 'CREATE_DATE';
  KEY_COLUMN_PART_TYPE := 'JOUR';
  PART_OWNER := 'MON';
  PART_TABLE_NAME := 'IT_GIMAC_CHILD_TRANS';
  PART_PARTITION_NAME := 'IT_GIMAC_CHILD_TRANS_';
