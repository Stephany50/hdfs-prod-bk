INSERT INTO  CDR.SPARK_IT_OMNY_SERVICES_CHARGES  PARTITION (START_DATE,FILE_DATE)
SELECT
ORIGINAL_FILE_NAME ,
ORIGINAL_FILE_SIZE ,
...
LEFT JOIN (SELECT DISTINCT original_file_name FILE_NAME FROM   CDR.SPARK_IT_OMNY_SERVICES_CHARGES_DETAILS) T ON T.file_name = C.original_file_name
