INSERT INTO CDR.SPARK_IT_OM_SUBSCRIBERS PARTITION (MODIFICATION_DATE,FILE_DATE)
SELECT
	USER_ID,
	PROFILE_ID,
	PARENT_USER_ID,
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_OM_SUBSCRIBERS WHERE MODIFICATION_DATE BETWEEN DATE_SUB(CURRENT_DATE,7) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
