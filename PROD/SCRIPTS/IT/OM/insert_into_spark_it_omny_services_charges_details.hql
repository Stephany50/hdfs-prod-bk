INSERT INTO CDR.SPARK_IT_OMNY_SERVICES_CHARGES_DETAILS
SELECT
	TRANSACTION_ID,
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_OMNY_SERVICES_CHARGES_DETAILS WHERE TRANSACTION_DATE BETWEEN DATE_SUB(CURRENT_DATE,${hivevar:date_offset}) AND CURRENT_DATE )T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
