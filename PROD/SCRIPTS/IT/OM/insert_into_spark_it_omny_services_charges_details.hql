INSERT INTO CDR.SPARK_IT_OMNY_SERVICES_CHARGES_DETAILS PARTITION (TRANSACTION_DATE,FILE_DATE)
SELECT
	TRANSACTION_ID,
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM CDR.SPARK_IT_OMNY_SERVICES_CHARGES_DETAILS)T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME WHERE T.FILE_NAME IS NULL
