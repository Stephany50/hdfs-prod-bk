INSERT INTO CDR.SPARK_IT_CHANSIM
SELECT
    Cust_ID  ,
    SUBS_ID  ,
    ICCID  ,
...
FROM CDR.TT_CHANSIM  C
         LEFT JOIN (SELECT DISTINCT original_file_name FILE_NAME FROM CDR.SPARK_IT_CHANSIM) T ON T.file_name = C.original_file_name
