INSERT INTO CDR.SPARK_IT_CHANTEL
SELECT
    CustId  ,
    Subs_id  ,
    ACCNBR  ,
...
FROM CDR.TT_CHANTEL  C
         LEFT JOIN (SELECT DISTINCT original_file_name FILE_NAME FROM CDR.SPARK_IT_CHANTEL) T ON T.file_name = C.original_file_name
