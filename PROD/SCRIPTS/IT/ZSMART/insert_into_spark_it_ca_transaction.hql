INSERT INTO CDR.SPARK_IT_CA_TRANSACTION
SELECT
...
FROM CDR.TT_CA_TRANSACTION  C
         LEFT JOIN (SELECT DISTINCT original_file_name FILE_NAME FROM   CDR.SPARK_IT_CA_TRANSACTION) T ON T.file_name = C.original_file_name
