 INSERT INTO cdr.spark_it_client_snapid_directory PARTITION(original_file_date)
SELECT
       msisdn,
       pwdclient,
...
FROM   cdr.tt_client_snapid_directory C
       LEFT JOIN (SELECT DISTINCT original_file_name FILE_NAME FROM   cdr.spark_it_client_snapid_directory) T ON T.file_name = C.original_file_name
