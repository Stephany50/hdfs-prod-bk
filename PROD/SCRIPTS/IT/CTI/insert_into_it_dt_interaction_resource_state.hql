INSERT INTO  CTI.IT_DT_INTERACTION_RESOURCE_STATE
SELECT
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM  CTI.IT_DT_INTERACTION_RESOURCE_STATE)T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
