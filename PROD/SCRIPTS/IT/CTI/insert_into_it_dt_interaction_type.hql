INSERT INTO  CTI.IT_DT_INTERACTION_TYPE
SELECT
...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FILE_NAME FROM  CTI.IT_DT_INTERACTION_TYPE)T ON T.FILE_NAME=C.ORIGINAL_FILE_NAME
