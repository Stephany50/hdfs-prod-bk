...
SELECT
INTERACTION_ID,
FROM_UNIXTIME(UNIX_TIMESTAMP(START_TIME, 'dd/MM/yyyy HH:mm:ss')) START_TIME,
FROM_UNIXTIME(UNIX_TIMESTAMP(END_TIME_TS, 'dd/MM/yyyy HH:mm:ss')) END_TIME_TS,
INTERACTION_TYPE,
MSIDSN,
FROM_UNIXTIME(UNIX_TIMESTAMP(DATE_TIME_AGG, 'dd/MM/yyyy HH:mm:ss')) DATE_TIME_AGG,
FROM_UNIXTIME(UNIX_TIMESTAMP(ThirtyMinAgg, 'dd/MM/yyyy HH:mm:ss')) ThirtyMinAgg,
RESOURCES,
RESOURCE_TYPE,
RESOURCE_SUBTYPE,
AGENT_FIRST_NAME,
