...
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_CRA_GPRS" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_CRA_GPRS_POST" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_A_GPRS_ACTIVITY" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_A_GPRS_ACTIVITY_POST" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_BILLED_TRANSACTION_PREPAID" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_BILLED_TRANSACTION_POSTPAID" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_GSM_TRAFFIC_REVENUE_DAILY" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_GSM_TRAFFIC_REVENUE_POST" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_DATA_TRANSFER" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_A_DATA_TRANSFER" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_SUBSCRIPTION" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_A_SUBSCRIPTION" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_RECHARGE" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_REFILL" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_EMERGENCY_DATA" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
--INSERT INTO FT_DAILY_STATUS
--SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_CREDIT_TRANSFERT" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
--FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_MSC_TRANSACTION" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_AG_INTERCO" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_X_INTERCO_FINAL" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_SMSC_TRANSACTION_A2P" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FTA' TABLE_TYPE, "FT_QOS_SMSC_SPECIAL_NUMBER" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_SUBS_RETAIL_ZEBRA" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
...
INSERT INTO FT_DAILY_STATUS
SELECT '###SLICE_VALUE###' FT_DATE,'FT' TABLE_TYPE, "FT_OVERDRAFT" TABLE_NAME, IF(FT_EXISTS=0,'NOK','OK') STATUS, FT_EXISTSS,CURRENT_TIMESTAMP INSERT_DATE
FROM (
