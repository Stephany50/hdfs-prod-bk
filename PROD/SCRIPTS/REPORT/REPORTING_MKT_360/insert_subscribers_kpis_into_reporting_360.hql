...
SELECT
    ...
    (
        case
            when KPI_NAME = 'DATA_USERS_MTD' then 'USERS'
            else 'SUBSCRIBERS'
        end
    ) KPI_GROUP_NAME,
    KPI_NAME,
...
(
    ...
    where transaction_date = '###SLICE_VALUE###'
        and DESTINATION_CODE in ('USER_GROSS_ADD_SUBSCRIPTION', 'USER_ART', 'USER_GROUP', 'PARC_OM_DAILY', 'PARC_OM_MTD', 'PARC_OM_30Jrs', 'OTARIE_DATA_USERS_30_DAYS_1Mo', 'OTARIE_DATA_USERS_MTD_1Mo', 'OTARIE_DATA_USERS_7_DAYS_1Mo','OTARIE_DATA_USERS_DAILY_1Mo', 'USER_DAILY_ACTIVE', 'USER_30DAYS_GROUP')
    group by region_id,
        case
            WHEN DESTINATION_CODE = 'USER_ART' THEN 'PARC_ART'
            WHEN DESTINATION_CODE = 'USER_GROUP' THEN 'PARC_GROUP'
