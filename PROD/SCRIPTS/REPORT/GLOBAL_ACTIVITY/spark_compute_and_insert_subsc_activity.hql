...
(
    SELECT DATECODE
        , BENEFIT_NAME
        , PRICE_PLAN_NAME
        , (COEFF_DATA + COEFF_ROAMING_DATA)*SUBS_EVENT_RATED_COUNT SUBS_EVENT_RATED_COUNT
        , (COEFF_DATA + COEFF_ROAMING_DATA)*TOTAL_AMOUNT TOTAL_AMOUNT
        , SUBS_CHANNEL
        , SUBS_SERVICE
        , OPERATOR_CODE
    FROM 
...
(
    SELECT DATECODE
        , BENEFIT_NAME
        , PRICE_PLAN_NAME
        , (COEFF_ONNET + COEFF_OFFNET + COEFF_INTER + COEFF_ROAMING_VOIX)*SUBS_EVENT_RATED_COUNT SUBS_EVENT_RATED_COUNT
        , (COEFF_ONNET + COEFF_OFFNET + COEFF_INTER + COEFF_ROAMING_VOIX)*TOTAL_AMOUNT TOTAL_AMOUNT
        , SUBS_CHANNEL
        , SUBS_SERVICE
        , OPERATOR_CODE
    FROM 
...
(
    SELECT DATECODE
        , BENEFIT_NAME
        , PRICE_PLAN_NAME
        , (COEF_SMS + COEFF_ROAMING_SMS)*SUBS_EVENT_RATED_COUNT SUBS_EVENT_RATED_COUNT
        , (COEF_SMS + COEFF_ROAMING_SMS)*TOTAL_AMOUNT TOTAL_AMOUNT
        , SUBS_CHANNEL
        , SUBS_SERVICE
        , OPERATOR_CODE
    FROM 
