...
SUM(NBR_GSM_VOX_POST)  in_nbr_gsm_vox_post,
SUM(GSM_VOX_POST_VOL)  in_gsm_vox_post_vol,
SUM(GSM_VOX_POST_TAX_AMT)  in_gsm_vox_post_tax_amt,
SUM(NBR_GSM_SMS_POST)  in_nbr_gsm_sms_post,
SUM(GSM_SMS_POST_TAX_AMT)  in_gsm_sms_post_tax_amt,
