INSERT INTO AGG.SPARK_REVENUE_SUMMARY_DAILY  (EVENT_DATE, IN_NBR_GSM_VOX_POST, IN_GSM_VOX_POST_VOL, IN_GSM_VOX_POST_TAX_AMT, IN_NBR_GSM_SMS_POST, IN_GSM_SMS_POST_TAX_AMT)
SELECT
    EVENT_DATE
