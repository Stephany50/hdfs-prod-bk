...
SUM(NBR_GPRS_SVA)  in_nbr_gprs_sva,
SUM(GPRS_SVA_VOL)  in_gprs_sva_vol,
SUM(GPRS_SVA_TAX_AMT)  in_gprs_sva_tax_amt,
SUM(NBR_GPRS_PAYGO)  in_nbr_gprs_paygo,
SUM(GPRS_PAYGO_VOL)  in_gprs_paygo_vol,
SUM(GPRS_PAYGO_TAX_AMT)  in_gprs_paygo_tax_amt,
