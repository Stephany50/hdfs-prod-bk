INSERT INTO AGG.SPARK_REVENUE_SUMMARY_DAILY  (EVENT_DATE, IN_NBR_ADJ_RBT, IN_ADJ_RBT_TAX_AMT, IN_NBR_ADJ_USS, IN_ADJ_USS_TAX_AMT
...
SELECT
    EVENT_DATE
     , SUM(NBR_ADJ_RBT) NBR_ADJ_RBT
     , SUM(ADJ_RBT_TAX_AMT) ADJ_RBT_TAX_AMT
     , SUM(NBR_ADJ_USS) NBR_ADJ_USS
     , SUM(ADJ_USS_TAX_AMT) ADJ_USS_TAX_AMT
     , SUM(NBR_ADJ_VOI_SMS) NBR_ADJ_VOI_SMS
     , SUM(ADJ_VOI_SMS_TAX_AMT) ADJ_VOI_SMS_TAX_AMT
     , SUM(NBR_ADJ_VEXT) NBR_ADJ_VEXT
     , SUM(ADJ_VEXT_TAX_AMT) ADJ_VEXT_TAX_AMT
     , SUM(NBR_ADJ_PAR) NBR_ADJ_PAR
     , SUM(ADJ_PAR_TAX_AMT) ADJ_PAR_TAX_AMT
     , SUM(NBR_ADJ_FBO) NBR_ADJ_FBO
     , SUM(ADJ_FBO_TAX_AMT) ADJ_FBO_TAX_AMT
     , SUM(NBR_ADJ_CEL) NBR_ADJ_CEL
     , SUM(ADJ_CEL_TAX_AMT) ADJ_CEL_TAX_AMT
     , SUM(NBR_ADJ_SIG) NBR_ADJ_SIG
     , SUM(ADJ_SIG_TAX_AMT) ADJ_SIG_TAX_AMT
FROM
    (
        SELECT
            EVENT_DATE
