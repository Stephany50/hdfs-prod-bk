...
ABS((subs_amount_valeur_j_0 / subs_amount_valeur_j_1) -1) <= 0.4 AND 
ABS((amount_data_valeur_j_0 / amount_data_valeur_j_1) -1) <= 0.4 AND 
ABS((bundle_tel_duration_valeur_j_0 / bundle_tel_duration_valeur_j_1) -1) <= 0.4 AND 
ABS((bundle_sms_count_valeur_j_0 / bundle_sms_count_valeur_j_1) -1) <= 0.4
,'OK','NOK')
 FROM
