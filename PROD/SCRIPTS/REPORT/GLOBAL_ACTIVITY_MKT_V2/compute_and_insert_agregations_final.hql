...
SELECT
    ...
    null mtd_last_year,
    if(lweek.valeur is null ,null,round((week.valeur-lweek.valeur)/lweek.valeur,2)*100 ) vslweek,
    if(2wa.valeur is null ,null,round((week.valeur-2wa.valeur)/2wa.valeur,2)*100)   vs2wa,
    if(3wa.valeur is null ,null,round((week.valeur-3wa.valeur)/3wa.valeur,2)*100)   vs3wa,
    if(4wa.valeur is null ,null,round((week.valeur-4wa.valeur)/4wa.valeur,2)*100 )  vs4wa,
    if(lmtd.valeur is null ,null,round((mtd.valeur-lmtd.valeur)/lmtd.valeur,2)*100)   mtdvslmdt,
    if(budget_mtd.valeur is null ,null,round((mtd.valeur-budget_mtd.valeur)/budget_mtd.valeur,2)*100) mdtvsbudget,
    if(budget.valeur is null ,null,round((week.valeur-budget.valeur)/budget.valeur,2)*100) weekvsbudget,
    if(budget_lweek.valeur is null ,null,round((lweek.valeur-budget_lweek.valeur)/budget_lweek.valeur,2)*100) lweekvsblweek,
    if(budget_2wa.valeur is null ,null,round((2wa.valeur-budget_2wa.valeur)/budget_2wa.valeur,2)*100) v2wavsb2wa,
    if(budget_3wa.valeur is null ,null,round((3wa.valeur-budget_3wa.valeur)/budget_3wa.valeur,2)*100) v3wavsb3wa,
    if(budget_4wa.valeur is null ,null,round((4wa.valeur-budget_4wa.valeur)/budget_4wa.valeur,2)*100) v4wavsb4wa,
