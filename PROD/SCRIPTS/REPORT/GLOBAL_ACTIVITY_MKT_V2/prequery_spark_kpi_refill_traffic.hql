...
ABS((refill_amount_valeur_j_0 / refill_amount_valeur_j_1) - 1) <= 0.4 and 
ABS((rated_amount_valeur_j_0 / rated_amount_valeur_j_1) - 1) <= 0.4 and 
ABS((available_balance_valeur_j_0 / available_balance_valeur_j_1) - 1) <= 0.4 
,'OK','NOK')
 FROM
