INSERT INTO TMP.SPARK_FT_AG_INTERCO_2_CEMAC
SELECT
served_imsi
,SERVED_MSISDN
,OTHER_PARTY
...
FROM (
    SELECT
        ...
        , FN_INTERCO_TRUNCKNAME_DEST (replace(MAX(TRUNCK_OUT), 'IMTN-', 'IMTNC-'))  TRUNCK_OUT
        , FN_INTERCO_TRUNCKNAME_DEST (replace(MIN(TRUNCK_IN), 'IMTN-', 'IMTNC-'))  TRUNCK_IN
    ...
    WHERE TRANSACTION_DATE = '###SLICE_VALUE###' AND transaction_type like "%TEL%"
