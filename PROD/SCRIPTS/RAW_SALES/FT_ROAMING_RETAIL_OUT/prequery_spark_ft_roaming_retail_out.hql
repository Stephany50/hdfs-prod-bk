...
T_4.MON.SPARK_FT_BILLED_TRANSACTION_POSTPAID > 0 and T_5.FT_CRA_GPRS > 0 ,"OK","NOK") FT_ROAM_EXIST
FROM
...
(SELECT COUNT(*) FT_CRA_GPRS FROM MON.SPARK_FT_CRA_GPRS WHERE TRANSACTION_DATE = '###SLICE_VALUE###') T_5
