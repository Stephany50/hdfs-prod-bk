CREATE TABLE MON.SPARK_FT_MY_ORANGE (
    ...
    new_users_backend_daily_percentage double,
    new_users_backend_weekly_percentage double,
    new_users_backend_mtd_percentage double,
    ...
    welcome_pack_takers_new_backend_daily_percentage double,
    welcome_pack_takers_new_backend_weekly_percentage double,
    welcome_pack_takers_new_backend_mtd_percentage double,
    welcome_pack_data_usage_daily double,
    welcome_pack_data_usage_weekly double,
    welcome_pack_data_usage_mtd double,
    ...
    myway_plus_revenu_backend_daily double,
    myway_plus_revenu_backend_weekly double,
    myway_plus_revenu_backend_mtd double,
