 CREATE TABLE if not exists DIM.DT_BASE_IDENTIFICATION4
(
    MSISDN                    VARCHAR(4000),
    NOM                       VARCHAR(100),
    PRENOM                    VARCHAR(100),
...
INSERT INTO DIM.DT_BASE_IDENTIFICATION4 select
    MSISDN,
    NOM,
    PRENOM,
    NEE_LE,
    ...
    MOTIF_REJET
from MON.backup_DT_BASE_IDENTIFICATION where backup_date='2019-09-05'
