select
if(A.otarie>=10 and B.ftcltd >= 10 and B2.ftclast_td >= 10 and C.ftcsnsht >= 10  and K.itkyc >= 10  and C2.ftimon >= 10 and D.ftcrmcem  = 0
            ,'OK','NOK')
...
,(SELECT count(*) as itkyc from CDR.SPARK_IT_KYC_BDI_FULL where original_file_date = date_add('###SLICE_VALUE###', 1)) K
