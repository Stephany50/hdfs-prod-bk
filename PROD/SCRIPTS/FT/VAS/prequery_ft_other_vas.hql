...
(SELECT COUNT(*) COUNT_IT_P2P_LOG FROM cdr.it_p2p_log WHERE START_DATE='###SLICE_VALUE###' LIMIT 10) B,
(SELECT COUNT(*) COUNT_FT_CONTRACT_SNAPSHOT FROM mon.ft_contract_snapshot WHERE EVENT_DATE='###SLICE_VALUE###' LIMIT 10) C