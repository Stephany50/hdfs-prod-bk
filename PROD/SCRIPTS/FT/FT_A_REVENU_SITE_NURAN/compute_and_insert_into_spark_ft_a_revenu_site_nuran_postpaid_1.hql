...
(
    ...
    (
        SELECT
            ...
            , COALESCE(a.CI, b.CI) as CI
            , a.DESTINATION
            , b.MAIN_COST AS DATA_MAIN_AMOUNT
            , b.PROMO_COST AS DATA_PROMO_AMOUNT
            , b.BYTES_RECEIVED /1024/1024 AS DATA_VOLUME_MO
        ...
        (
            ...
            (
                ...
                inner join (select '62008' ci, 'Mbang' site_name) vdci
            ...
            (
                ...
                (
                    ...
                    (
                        select
                            ci
                        from (select '62008' ci, 'Mbang' site_name) a
                    ) b
                ) vdci
