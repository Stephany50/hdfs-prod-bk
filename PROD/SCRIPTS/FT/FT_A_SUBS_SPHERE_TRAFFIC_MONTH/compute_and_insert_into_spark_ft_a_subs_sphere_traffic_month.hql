...
,count(distinct case when duree_sortant > 0 then other_party else null end) NB_NUM_APPELLES
,count(distinct case when duree_entrant > 0 then other_party else null end) NB_NUM_APPELANTS
,event_month
