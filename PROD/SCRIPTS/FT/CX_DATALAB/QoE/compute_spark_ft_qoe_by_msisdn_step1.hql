...
100*(sum(nvl(TCPSESSIONOKDOWN,0)+nvl(TCPSESSIONOKSTREAM,0)+nvl(TCPSESSIONOKWEB,0)+nvl(TCPSESSIONOKVOIP,0))/
sum(nvl(TCPSESSIONOKDOWN,0)+nvl(TCPSESSIONKODOWN,0)+nvl(TCPSESSIONOKSTREAM,0)+nvl(TCPSESSIONKOSTREAM,0)+
nvl(TCPSESSIONOKWEB,0)+nvl(TCPSESSIONKOWEB,0)+nvl(TCPSESSIONOKVOIP,0)+nvl(TCPSESSIONKOVOIP,0))) QoE_DATA,
...
100*(sum(nvl(TCPSESSIONOKWEB,0))/sum(nvl(TCPSESSIONOKWEB,0)+nvl(TCPSESSIONKOWEB,0))) QoE_WEB,
100*(sum(nvl(TCPSESSIONOKVOIP,0))/sum(nvl(TCPSESSIONOKVOIP,0)+nvl(TCPSESSIONKOVOIP,0))) QoE_VOIP
