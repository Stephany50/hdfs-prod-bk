...
CREATE TABLE MON.SQ_FT_CXD_NBRE_TRANS_EC (
    numero varchar(200),
    nbre_echecs_transactions_om NUMBER,
    erreur_echec  varchar(1000),
    insert_date DATE,
    EVENT_DATE DATE
);
...
CREATE TABLE TMP.SQ_FT_CXD_NBRE_TRANS_EC(
    numero varchar(200),
    nbre_echecs_transactions_om bigint,
    erreur_echec  varchar(1000),
    insert_date timestamp,
...
BEGIN 
  SAMPLE_TABLE := 'MON.SQ_FT_CXD_NBRE_TRANS_EC';
  MIN_DATE_PARTITION := '20220101';
  MAX_DATE_PARTITION := '20270101';
  KEY_COLUMN_PART_NAME := 'EVENT_DATE';
  KEY_COLUMN_PART_TYPE := 'JOUR';
  PART_OWNER := 'MON';
  PART_TABLE_NAME := 'FT_CXD_NBRE_TRANS_EC';
  PART_PARTITION_NAME := 'FT_CXD_NBRE_TRANS_EC_';
  PART_TYPE_PERIODE := 'JOUR';
  PART_RETENTION := 1000;
  PART_TBS_CIBLE :=  'TAB_P_MON_J10_256M';
