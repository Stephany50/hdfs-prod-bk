...
(
    ...
    INNER JOIN
    (
        SELECT distinct EVENT_DATE, event_time FROM DD.SPARK_FT_RUPT_RETAILER_OM where event_date=CURRENT_DATE() order by event_date desc, event_time desc LIMIT 1
    ) B
