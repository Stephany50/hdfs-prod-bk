...
SELECT 
  ...
  NVL(NVL(E.SITE_NAME, F.SITE_NAME), NVL(D.SITE_NAME, D2.SITE_NAME)) SITE_NAME,
  NVL(NVL(E.SITE_SOURCE, F.SITE_SOURCE), NVL(D.SITE_SOURCE, D2.SITE_SOURCE)) SITE_SOURCE,
