...
(
    ...
    (
        SELECT
            ...
            TYPE_DOCUMENT,
            FICHIER_CHARGEMENT
        FROM (SELECT * FROM CDR.IT_PREPAID_CLIENT_DIRECTORY WHERE  ORIGINAL_FILE_DATE in (select original_file_date AS T  from CDR.IT_PREPAID_CLIENT_DIRECTORY GROUP BY original_file_date ORDER BY original_file_date DESC limit 1)) TY
