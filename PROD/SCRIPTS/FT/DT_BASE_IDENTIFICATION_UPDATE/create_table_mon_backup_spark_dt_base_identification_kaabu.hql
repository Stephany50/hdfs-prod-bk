...
CREATE TABLE MON.BACKUP_SPARK_DT_BASE_IDENTIFICATION_KAABU
(
    MSISDN                    VARCHAR(4000),
    NOM                       VARCHAR(100),
    PRENOM                    VARCHAR(100),
...
create table DIM.SPARK_DT_BASE_IDENTIFICATION_KAABU
as select * from DIM.SPARK_DT_BASE_IDENTIFICATION;