...
SELECT
	...
	IF(a.msisdn IS NULL OR b.telephone IS NULL, nvl(a.TYPEDECONTRAT, b.TYPEDECONTRAT), b.TYPEDECONTRAT) TYPEDECONTRAT
...
(
	select
		...
		date_mise_a_jour,date_table_mis_a_jour,genre,civilite,TYPE_PIECE_IDENTIFICATION,PROFESSION_IDENTIFICATEUR,MOTIF_REJET,TYPEDECONTRAT
	from
	(
	select
		TELEPHONE ,
		...
		null PROFESSION_IDENTIFICATEUR,
		null MOTIF_REJET ,
		TYPEDECONTRAT, -- add typedecontrat
