INSERT INTO MON.FT_PDM_TRANSACTION_OTHER
...
SELECT '2019-01-01' --cast(CURRENT_TIMESTAMP as date)  EVENT_DATE
    ,CASE WHEN LENGTH(OTHER_PARTY) = 13 AND substr(OTHER_PARTY,1,3) = '160' AND FN_GET_NNP_MSISDN_SIMPLE_DESTN(OTHER_PARTY)
...
GROUP BY CASE WHEN LENGTH(OTHER_PARTY) = 13 AND substr(OTHER_PARTY,1,3) = '160' AND FN_GET_NNP_MSISDN_SIMPLE_DESTN(OTHER_PARTY)
