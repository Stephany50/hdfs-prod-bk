...
SELECT
    ...
    IF(a.event_date IS NULL OR b.event_date IS NULL OR a.substr(a.imei, 1, 14) IS NULL OR b.substr(a.imei, 1, 14) IS NULL, nvl(a.SITE_DATA, b.SITE_DATA), b.SITE_DATA) SITE_DATA,
...
ON (A.EVENT_DATE = B.EVENT_DATE, SUBSTR(A.IMEI, 1, 14) = SUBSTR(B.IMEI, 1, 14) )