insert into TMP.TT_FT_BDI_II_ART
SELECT
...
.MSISDN),-9,9)
LEFT JOIN (SELECT DISTINCT MSISDN, DATE_ACTIVATION AS EVENT_DATE FROM MON.SPARK_FT_BDI_ART WHERE EVENT_DATE =
