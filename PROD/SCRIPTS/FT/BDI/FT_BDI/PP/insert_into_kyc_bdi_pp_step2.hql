...
(CASE WHEN F.NUMERO_PIECE IS NOT NULL AND trim(F.NUMERO_PIECE) <> '' AND A.TYPE_PERSONNE_I='PP' THEN 'OUI' 
WHEN J.NUMERO_PIECE IS NOT NULL AND trim(J.NUMERO_PIECE) <> '' AND A.TYPE_PERSONNE_I='PDV' THEN 'OUI' ELSE 'NON' END) MULTI_SIM,
