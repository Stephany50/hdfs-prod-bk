...
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND
...
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND  A.NUMERO_PIECE_UNIQUEMENT_LETTRE = 'OUI' then 1 else 0 end)
...
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND  A.NUMERO_PIECE_A_CARACT_NON_AUTH ='OUI' then 1 else 0 end)
NB_NUM_PIECE_A_CARACT_NON_AUTH
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND  A.NUMERO_PIECE_EGALE_MSISDN ='OUI' then 1 else 0 end)
...
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND  A.NOM_PRENOM_DOUTEUX ='OUI' then 1 else 0 end) NB_NOM_PRENOM_DOUTEUX
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
...
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND  A.ADRESSE_ABSENT = 'OUI' then 1 else 0 end) ADRESSE_ABSENT
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND  A.ADRESSE_DOUTEUSE = 'OUI' then 1 else 0 end) NB_ADDRESSE_DOUTEUSE
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
...
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND  (A.TYPE_PIECE IS NULL OR A.TYPE_PIECE = '') THEN 1 ELSE 0 END) NB_TYPE_PIECE_IDENTITE
...
,SUM (case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND A.DATE_ACTIVATION IS NULL THEN 1 ELSE 0 END) NB_DATE_SOUSCRIPTION_ABSENTE
,sum(case when not(A.msisdn is null or trim(A.msisdn) = '') AND
...
, sum ( case when not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' AND (A.PLAN_LOCALISATION is null OR A.PLAN_LOCALISATION = '')
then 1 ELSE 0 END )
NB_PLAN_LOCALISATION_ABSENT
,sum(CASE WHEN not(A.msisdn is null or trim(A.msisdn) = '') AND
A.est_suspendu = 'NON' AND A.CONFORME_ART = 'NON' THEN 1 ELSE 0 END) NB_LIGNES_EN_ANOMALIE
...
FROM (
   ...
   where type_personne IN ('MAJEUR','PP') and EVENT_DATE = to_date('###SLICE_VALUE###')
) A
left join (
