-- Table contenant les personnes physiques et les champs de decision sur la conformité : La BDI Améliorée.
CREATE TABLE MON.SPARK_FT_KYC_BDI_PP_AM (
MSISDN VARCHAR(255),
...
) COMMENT 'SPARK_FT_KYC_BDI_PP_AM'
