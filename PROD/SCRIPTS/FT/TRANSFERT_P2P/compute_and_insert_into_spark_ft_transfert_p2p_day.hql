...
WHERE T.REFILL_DATE BETWEEN add_months(CONCAT(SUBSTRING('###SLICE_VALUE###',0,7),'-','01'),0) and ###SLICE_VALUE###
AND EVENT_DATE=add_months(CONCAT(SUBSTRING('###SLICE_VALUE###',0,7),'-','01'),0)
