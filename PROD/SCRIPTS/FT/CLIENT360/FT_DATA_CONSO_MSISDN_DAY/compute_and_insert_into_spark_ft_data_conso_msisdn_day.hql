-- @TRAITEMENT :: RECUPERER LES DONNÉES  ET  INSERER LES DONNÉES AGREGÉES <MON.SPARK_FT_DATA_CONSO_MSISDN_DAY>
-- EVENT_DATE, MSISDN, FORMULE, CONSO, SMS_COUNT, TEL_COUNT, TEL_DURATION, BILLED_SMS_COUNT, BILLED_TEL_COUNT, BILLED_TEL_DURATION
INSERT INTO MON.SPARK_FT_DATA_CONSO_MSISDN_DAY
SELECT
...
,    BUNDLE_BYTES_REMAINING_VOLUME, BUNDLE_MMS_REMAINING_VOLUME,   SRC_TABLE SOURCE_TABLE,    OPERATOR_CODE,    INSERT_DATE,Throttling_Vol,EVENT_DATE
    FROM (
    SELECT
