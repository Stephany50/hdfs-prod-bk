...
SELECT
    ...
    (case
        when A.TYPE_PERSONNE is  NULL then A.CONFORM_ART_P_PHY_MAJEUR
        when A.TYPE_PERSONNE ='MAJEUR' then A.CONFORM_ART_P_PHY_MAJEUR
        when A.TYPE_PERSONNE='PP' then  A.CONFORM_ART_P_PHY_MAJEUR
        when A.TYPE_PERSONNE ='MINEUR' then  A.CONFORM_ART_P_PHY_MINEUR
        when A.TYPE_PERSONNE ='PERSONNE_MORALE' then A.CONFORM_ART_P_MORALE_FLOTTE
        when A.TYPE_PERSONNE ='MACHINE_2_MACHINE' then  A.CONFORM_ART_P_MORALE_M2M
        else A.TYPE_PERSONNE
    end)  CONFORME_ART,
    (case
        when A.TYPE_PERSONNE is  NULL then A.CONFORM_ART_P_PHY_MAJEUR
        when A.TYPE_PERSONNE ='MAJEUR' then A.CONFORM_ART_P_PHY_MAJEUR
        when A.TYPE_PERSONNE ='PP' then A.CONFORM_OCM_P_PHY_MAJEUR
        when A.TYPE_PERSONNE ='MINEUR' then A.CONFORM_OCM_P_PHY_MINEUR
        when A.TYPE_PERSONNE ='PERSONNE_MORALE' then A.CONFORM_OCM_P_MORALE_FLOTTE
        when A.TYPE_PERSONNE ='MACHINE_2_MACHINE' then A.CONFORM_OCM_P_MORALE_M2M
        else  A.TYPE_PERSONNE
    end) CONFORME_OCM,
