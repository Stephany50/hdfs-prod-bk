...
SELECT
    MSISDN,
    NULL DATE_PREMIERE_ACTIVATION, --à revoir
    TYPE_PIECE,
    NUMERO_PIECE,
    SEX,
    DIR_FIRST_NAME,
...
FROM (
    ...
    (
        ...
        (
            ...
            (
                ...
                WHERE EVENT_DATE = DATE_ADD('2020-02-27',1)
        ...
        (
            ...
            FULL JOIN (
                ...
                WHERE EVENT_DATE=DATE_ADD('2020-02-27',1) AND FN_NNP_SIMPLE_DESTINATION(MSISDN)='OCM'
            ) A12
    ...
    (
        ...
        (
            ...
            WHERE D01.EVENT_DATE = '2020-02-27'
        ) D0
        WHERE D0.RN=1
    ...
    (
        ...
        (
            ...
            WHERE E01.REFILL_DATE = '2020-02-27'
        ...
        (
            ...
            WHERE E11.REFILL_DATE = '2020-02-27'
    ...
    (
        ...
        WHERE F0.TRANSACTION_DATE = '2020-02-27'
    ...
    (
        ...
        WHERE G0.EVENT_DATE = '2020-02-27'
    ...
    (
        ...
        (
            ...
            (
                ...
                WHERE H010.TRANSACTION_DATE = '2020-02-27'
            ) H01
            LEFT JOIN
            (
                SELECT
    ...
    (
        ...
        FROM (
            ...
            WHERE I01.TRANSACTION_DATE = '2020-02-27'
        ) I0
        GROUP BY I0.MSISDN
    ...
    (
        ...
        FROM (
            SELECT
                ...
                J01.SENDER_PRE_BAL,
                J01.SENDER_POST_BAL,
                J01.RECEIVER_PRE_BAL,
                J01.RECEIVER_POST_BAL
            FROM CDR.SPARK_IT_OMNY_TRANSACTIONS J01
            WHERE J01.ORIGINAL_FILE_DATE = '2020-02-27'
        ) J0
        GROUP BY J0.MSISDN
    ...
    (
        ...
        WHERE K0.EVENT_DATE="2020-02-27"
    ...
    (
        ...
        WHERE M0.DATE_INSCRIPT = '2020-02-27'
