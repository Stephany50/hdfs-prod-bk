                        ...
                        (
                            ...
                            (
                                ...
                                (
                                    ...
                                    FULL JOIN
                                    (
                                        SELECT MSISDN, SUBSTR(IMEI_MOST_USED,1,8) AS TER_TAC_CODE, SUBSTR(IMEI_MOST_USED,1,8) AS TER_IMEI, CONSTRUCTOR AS TER_CONSTRUCTOR, MODEL AS TER_MODEL,
                                        ...
                                        FROM
                                        (
                                          SELECT DISTINCT MSISDN,  IMEI_MOST_USED
                                          FROM
                                          (
                                             SELECT MSISDN
                                        ...
                                        , DIM.DT_HANDSET_REF
                                        WHERE  SUBSTR(IMEI_MOST_USED,1,8) = TAC_CODE
                                    ) b
                                        ON a.MSISDN = b.MSISDN
                                ) a
                                FULL JOIN
