...
,    BYTES_USED_IN_BUNDLE,    BYTES_USED_OUT_BUNDLE,    BYTES_USED_IN_BUNDLE_ROAMING,    BYTES_USED_OUT_BUNDLE_ROAMING,    BUNDLE_MMS_USED_VOLUME
...
,    BUNDLE_BYTES_REMAINING_VOLUME, BUNDLE_MMS_REMAINING_VOLUME

, ACTIVE_DAYS_COUNT, FIRST_ACTIVE_DAY, LAST_ACTIVE_DAY

,    SOURCE_TABLE,    OPERATOR_CODE,    INSERT_DATE, EVENT_MONTH)
SELECT
    a.MSISDN
     ...
     ,DATE_FORMAT('2019-09-10','yyyy-MM') EVENT_MONTH
...
FROM
    mon.FT_DATA_CONSO_MSISDN_DAY a
        ...
        WHERE a.EVENT_DATE = ADD_MONTHS (date_format('2019-09-10','yyyy-MM-01'), 1)
