...
(
    ...
    WHERE EVENT_DATE BETWEEN TO_DATE(CONCAT('2020-04','-01')) AND LAST_DAY(CONCAT('2020-04','-01'))
) A
LEFT JOIN (
    SELECT
        A.ACCESS_KEY MSISDN
    ...
    WHERE A.EVENT_DATE = ADD_MONTHS(CONCAT('2020-04','-01'), 1)
