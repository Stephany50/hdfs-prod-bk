create  table MON.FT_CLIENT_360 (
    MSISDN  VARCHAR(50),
    ...
    AMOUNT_EMERGENCY_DATA  DOUBLE,
    TRANSACTION_TYPE  VARCHAR(20),
    BYTES_OBTAINED  BIGINT,
    CONTACT_CHANNEL  VARCHAR(20),
    DATA_VIA_OM  VARCHAR(20),
    TRANSACTION_AMOUNT  DOUBLE,
    COMMISSIONS_PAID  DOUBLE,
    COMMISSIONS_RECEIVED  DOUBLE,
    COMMISSIONS_OTHERS  DOUBLE,
    SERVICE_CHARGE_RECEIVED  DOUBLE,
    SERVICE_CHARGE_PAID  DOUBLE,
    TAXES  DOUBLE,
