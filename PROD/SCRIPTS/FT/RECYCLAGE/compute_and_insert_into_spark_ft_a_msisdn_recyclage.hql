...
--truncate TABLE TMP.TT_A_MSISDN_RECYCLAGE;
--insert into TMP.TT_A_MSISDN_RECYCLAGE
SELECT EVENT_DATE, SUBSTR(MSISDN,1,3) TRANCHE_MSISDN, EST_PRESENT_ZEBRA, EST_PRESENT_OM, PROD_STATE_NAME, CASE WHEN BLOCK_REASON NOT LIKE '%0%' THEN BLOCK_REASON END BLOCK_REASON, ORDER_REASON,
     ...
     COUNT (*) NBRE_MSISDN, SUM(nvl(RECYCLABLE,0)) NBRE_RECYCLABLE
FROM MON.SPARK_FT_MSISDN_RECYCLAGE
WHERE EVENT_DATE = '2020-03-10'--###SLICE_VALUE###' --RECYCLABLE=1;
