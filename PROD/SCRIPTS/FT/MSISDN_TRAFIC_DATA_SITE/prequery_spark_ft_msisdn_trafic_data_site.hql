SELECT IF(T_1.COUNT_1 > 0 and T_2.COUNT_2 > 0 AND T_3.COUNT_3 > 0 AND T_4.COUNT_4 > 0 AND T_5.COUNT_5=0 ,"OK","NOK") FT_EXIST
FROM
...
(SELECT COUNT(*) COUNT_5 FROM MON.SPARK_FT_MSISDN_TRAFIC_DATA_SITE WHERE EVENT_DATE='###SLICE_VALUE###') T_5
