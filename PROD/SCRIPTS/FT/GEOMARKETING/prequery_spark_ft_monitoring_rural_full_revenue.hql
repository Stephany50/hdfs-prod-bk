SELECT IF(T_1.FT_MONITORING_RURAL_FULL_REVENUE_COUNT = 0 and T_2.FT_GEOMARKETING_REPORT_360_COUNT > 0 and T_3.FT_BILLED_TRANSACTION_PREPAID_COUNT > 0 and T_4.FT_CRA_GPRS_COUNT > 0 and T_5.FT_SUBSCRIPTION_COUNT > 0 and T_6.FT_SUBS_RETAIL_ZEBRA_COUNT > 0 and T_7.FT_CONTRACT_SNAPSHOT_COUNT > 0 and T_8.FT_CREDIT_TRANSFER_COUNT > 0 and T_9.FT_DATA_TRANSFER_COUNT > 0 and T_9.FT_DATA_TRANSFER_COUNT > 0 and T_10.FT_CLIENT_LAST_SITE_DAY_COUNT > 0 and T_11.FT_CLIENT_SITE_TRAFFIC_DAY_COUNT > 0 and T_12.FT_SITE_360_COUNT > 0 and T_13.FT_GEOMARKETING_REPORT_360_MTD_COUNT > 0 and T_14.FT_ACCOUNT_ACTIVITY_COUNT > 0 and T_15.IT_OMNY_TRANSACTIONS_COUNT > 0,"OK","NOK") COUNT_DAY_EXIST
FROM
