 -- @TRAITEMENT :: RECUPERER LES DONNÉES  ET  INSERER LES DONNÉES AGREGÉES <FT_PARCS_SITE_DAY>
             -- infos données dispo dans FT_CONTRACT_SNAPSHOT GSM prepaid , GSM postpaid, et Internet OCMS(vue BSCS => INTERNET_BILLING)
