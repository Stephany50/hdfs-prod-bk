...
(
    ...
    monthly_avg_recharge decimal(17, 2),
...
(
    ...
    plafond decimal(17, 2),
    last_loan_date_sos_credit timestamp,
    last_payback_list_sos_credit varchar(1000),
    last_loan_amount_sos_credit decimal(17, 2),
    avg_last_payback_amount_sos_credit decimal(17, 2),
    last_loan_id_sos_credit varchar(200),
    second_last_loan_date_sos_credit timestamp,
    second_last_loan_amount_sos_credit decimal(17, 2),
    avg_second_last_payback_amount_sos_credit decimal(17, 2),
    second_last_loan_id_sos_credit varchar(200),
    second_last_payback_list_sos_credit varchar(1000),
    last_loan_date_sos_data timestamp,
    last_payback_list_sos_data varchar(1000),
    last_loan_amount_sos_data decimal(17, 2),
    avg_last_payback_amount_sos_data decimal(17, 2),
    last_loan_id_sos_data varchar(200),
    second_last_loan_date_sos_data timestamp,
    second_last_loan_amount_sos_data decimal(17, 2),
    --avg_second_last_payback_amount_sos_data decimal(17, 2),
    second_last_loan_id_sos_data varchar(200),
    second_last_payback_list_sos_data varchar(1000),
    last_loan_date_sos_voix timestamp,
    last_payback_list_sos_voix varchar(1000),
    last_loan_amount_sos_voix decimal(17, 2),
    avg_last_payback_amount_sos_voix decimal(17, 2),
    last_loan_id_sos_voix varchar(200),
    second_last_loan_date_sos_voix timestamp,
    second_last_loan_amount_sos_voix decimal(17, 2),
    --avg_second_last_payback_amount_sos_voix decimal(17, 2),
    second_last_loan_id_sos_voix varchar(200),
    second_last_payback_list_sos_voix varchar(1000),
    insert_date timestamp
)
partitioned by (event_date date)
STORED AS PARQUET
...
create table dim.msisdn_sos_credit_non_conformes
(
    msisdn varchar(100)
)