...
SELECT
(CASE WHEN SERVICE_TYPE IN ('P2P','OTF') THEN 'P2P_OUT'
...
WHERE TRANSFER_DATETIME BETWEEN DATE_SUB('###SLICE_VALUE###',30)  AND '###SLICE_VALUE###' --ADD_MONTHS(v_process_date,-1) AND v_process_date
AND TRANSFER_STATUS='TS'
AND SENDER_CATEGORY_CODE='SUBS'
AND SERVICE_TYPE IN ('MERCHPAY','P2PNONREG','CASHOUT','BILLPAY','P2P','RC','OTF')
