...
SELECT
(CASE WHEN SERVICE_TYPE IN ('P2P') THEN 'P2P_IN' ELSE SERVICE_TYPE  END ) SERVICE_TYPE
...
AND SERVICE_TYPE IN ('CASHIN','P2P','ENT2REG')
GROUP BY TRANSFER_DATETIME,fn_format_msisdn_to_9digits(RECEIVER_MSISDN),(CASE WHEN SERVICE_TYPE IN ('P2P') THEN 'P2P_IN' ELSE SERVICE_TYPE  END )