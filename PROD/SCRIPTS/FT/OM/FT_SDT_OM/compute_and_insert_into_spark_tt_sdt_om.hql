...
(
    ...
    (
        ...
        (
            ...
            (
                SELECT
                    ...
                    DATE_FORMAT(REGISTERED_ON, 'yyyy-MM-dd') DATE_INSCRIPT,
                ...
                WHERE REGISTERED_ON BETWEEN SUBSTR('###SLICE_VALUE###', 0, 7) || '-01 00:00:00' AND '###SLICE_VALUE###' || ' 23:59:59'
        ...
        (
            ...
            WHERE T1.TRANSFER_DATETIME BETWEEN SUBSTR('###SLICE_VALUE###', 0, 7) || '-01' AND '###SLICE_VALUE###'
    ...
    (
        ...
        WHERE T3.TRANSFER_DATETIME BETWEEN SUBSTR('###SLICE_VALUE###', 0, 7) || '-01' AND '###SLICE_VALUE###'
