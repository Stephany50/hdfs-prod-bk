...
SELECT A1.MSISDN AS MSISDN, A1.USER_ID AS USER_ID, A1.CREATION_DATE AS CREATION_DATE,A1.USER_TYPE AS USER_TYPE,
      ...
      FROM
           ( SELECT *  FROM CDR.SPARK_IT_OM_SUBSCRIBERS WHERE MODIFICATION_DATE ='###SLICE_VALUE###' AND CREATION_DATE >= 1577833200) A1
      ...
      FROM
            ( SELECT *  FROM CDR.SPARK_IT_OM_SUBSCRIBERS WHERE MODIFICATION_DATE ='###SLICE_VALUE###' AND CREATION_DATE >= 1577833200) A2
