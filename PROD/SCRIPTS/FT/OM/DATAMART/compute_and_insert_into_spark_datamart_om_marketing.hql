...
-- CHANNEL ON RECEIVER MODE
    ...
    WHERE
        ...
        AND A.SERVICE_TYPE NOT IN ('P2P', 'P2PNONREG')
...
LEFT JOIN  (SELECT * FROM MON.SPARK_FT_CLIENT_LAST_SITE_DAY where event_date='2020-07-29')   D ON C.MSISDN=D.MSISDN