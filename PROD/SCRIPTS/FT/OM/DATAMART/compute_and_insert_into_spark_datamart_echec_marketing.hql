...
-- CHANNEL ON SENDER MODE
  SELECT
    ...
    FROM CDR.SPARK_IT_OMNY_TRANSACTIONS A JOIN MON.SPARK_REF_OM_PRODUCTS B
    ...
    GROUP BY
    A.TRANSACTION_DATE, (A.RECEIVER_USER_ID || '_' || A.RECEIVER_MSISDN), A.RECEIVER_MSISDN,
...
-- CHANNEL ON RECEIVER MODE
    ...
    WHERE
        ...
        B.REF_DATE='2019-10-17' AND A.SERVICE_TYPE NOT IN ('P2P', 'P2PNONREG')
    GROUP BY
    A.TRANSACTION_DATE, (A.SENDER_USER_ID || '_' || A.SENDER_MSISDN), A.SENDER_MSISDN, A.SERVICE_TYPE,
