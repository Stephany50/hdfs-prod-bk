...
-- TNO
    ...
    'TRANSFERT' STYLES,
        ...
        SUM(A.COMMISSIONS_RECEIVED) REVENU_INDIRECT,
        SUM(A.COMMISSIONS_PAID) COMMISSION
    FROM CDR.IT_OMNY_TRANSACTIONS A
    WHERE
        A.TRANSFER_STATUS='TS' AND
        A.transfer_datetime ='###SLICE_VALUE###' AND
...
-- RECEIVER CONNU
    ...
    GROUP BY
        ...
        A.RECEIVER_MSISDN,
        A.SERVICE_TYPE,
        (CASE WHEN SENDER_CATEGORY_CODE='SUBS' THEN 'REC_SENDER_CONNU' ELSE 'REC_SENDER_INCONNU' END)) C
