INSERT INTO AGG.SPARK_FT_A_TRAFFIC_ENTRANT_NURAN
 SELECT
 SITE_NAME, 
 ...
 SUM(DUREE_TEL_INTERN_ENTRANT) AS DUREE_TEL_INTERN_ENTRANT,
 SUM(NBRE_SMS_INTERN_ENTRANT) AS NBRE_SMS_INTERN_ENTRANT,

 SUM(NBRE_TEL_OCM_SHORT_ENTRANT) NBRE_TEL_OCM_SHORT_ENTRANT,
 SUM(NBRE_SMS_OCM_SHORT_SORTANT) NBRE_SMS_OCM_SHORT_SORTANT,
 SUM(DUREE_TEL_OCM_SHORT_ENTRANT) DUREE_TEL_OCM_SHORT_ENTRANT,
 SUM(DUREE_TEL_OCM_SHORT_SORTANT) DUREE_TEL_OCM_SHORT_SORTANT,
 SUM(NBRE_TEL_SET_ENTRANT) NBRE_TEL_SET_ENTRANT,
 SUM(NBRE_SMS_SET_SORTANT) NBRE_SMS_SET_SORTANT,
 SUM(DUREE_TEL_SET_ENTRANT) DUREE_TEL_SET_ENTRANT,
 SUM(NBRE_TEL_SET_SORTANT) NBRE_TEL_SET_SORTANT,
