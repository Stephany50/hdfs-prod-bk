...
select
    ...
    sum(case when (kpi = 'TAUX_30J') then val else 0 end) / sum(case when (kpi = 'CA_M-1') then val else 0 end) TAUX_30J,
    sum(case when (kpi = 'TAUX_60J') then val else 0 end) / sum(case when (kpi = 'CA_M-2') then val else 0 end) TAUX_60J,
    sum(case when (kpi = 'TAUX_90J') then val else 0 end) / sum(case when (kpi = 'CA_M-3') then val else 0 end) TAUX_90J,
    sum(case when (kpi = 'TAUX_90J_PLUS') then val else 0 end) / sum(case when (kpi = 'CA_90_PLUS') then val else  0 end) TAUX_90J_PLUS,
