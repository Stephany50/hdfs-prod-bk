...
CREATE TABLE MON.SPARK_FT_CRA_GPRS_WITH_BAL_ID (
    ...
    VLR_NUMBER  VARCHAR(300),
    USED_BAL_ID_LIST VARCHAR(255),
    USED_ACCT_RES_ID_LIST VARCHAR(255),
    USED_ACCT_ITEM_TYPE_ID_LIST VARCHAR(255)
) COMMENT 'MON.FT_CRA_GPRS_WITH_BAL_ID Table'
