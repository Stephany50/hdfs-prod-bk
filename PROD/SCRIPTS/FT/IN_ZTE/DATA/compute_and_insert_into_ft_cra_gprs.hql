...
FROM (
    ...
    FROM (
        ...
        FROM CDR.IT_ZTE_DATA a WHERE a.START_DATE = '2019-11-30'
        ) a
        ...
        LEFT JOIN (SELECT PRICE_PLAN_ID, PRICE_PLAN_NAME, PRICE_PLAN_CODE FROM CDR.IT_ZTE_PRICE_PLAN_EXTRACT WHERE ORIGINAL_FILE_DATE = '2019-11-30' ) pp1 ON (a.PRICE_PLAN_CODE = pp1.PRICE_PLAN_CODE)
