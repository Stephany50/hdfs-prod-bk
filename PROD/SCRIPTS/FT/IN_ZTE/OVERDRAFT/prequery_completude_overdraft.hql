...
FROM
(SELECT COUNT(DISTINCT ORIGINAL_FILE_NAME) CHECK_FILE_COUNT FROM CDR.IT_ZTE_CHECK_FILE WHERE CDR_DATE = '###SLICE_VALUE###' AND ORIGINAL_FILE_DATE = '###SLICE_VALUE###' AND ORIGINAL_FILE_NAME NOT LIKE '%POST%') T_4,
