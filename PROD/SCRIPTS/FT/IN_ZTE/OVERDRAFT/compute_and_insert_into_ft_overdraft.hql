...
,FROM_UNIXTIME(UNIX_TIMESTAMP(A.PAY_TIME,'dd/MM/yyyy HH:mm:ss')) TRANSACTION_TIME
...
LEFT JOIN (SELECT * FROM DWH_FT_CONTRACT_SNAPSHOT WHERE EVENT_DATE = '###SLICE_VALUE###' AND OSP_STATUS <> 'TERMINATED') B 
...
,FROM_UNIXTIME(UNIX_TIMESTAMP(A.CREATE_DATE,'DD/MM/YYYY HH:mm:SS')) TRANSFER_DATE_TIME
, 'AIRTIME' SERVICE_CODE
, 'REIMBURSMENT' OPERATION_TYPE
