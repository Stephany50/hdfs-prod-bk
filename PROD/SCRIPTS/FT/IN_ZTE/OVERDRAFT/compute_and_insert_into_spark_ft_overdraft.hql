INSERT INTO MON.SPARK_FT_OVERDRAFT PARTITION(TRANSACTION_DATE)
SELECT DISTINCT
...
FROM CDR.SPARK_IT_ZTE_RECHARGE A
         LEFT JOIN (SELECT * FROM MON.SPARK_FT_CONTRACT_SNAPSHOT WHERE EVENT_DATE = '###SLICE_VALUE###' AND OSP_STATUS <> 'TERMINATED') B
