 ...
 FROM (
    ...
    FROM
     (
        ...
        LEFT JOIN (SELECT * FROM MON.FT_CONTRACT_SNAPSHOT WHERE EVENT_DATE = '###SLICE_VALUE###' AND OSP_STATUS <> 'TERMINATED') b ON IF(regexp_replace( a.MSISDN,"^(237)+(?!$)","")='237',NULL,regexp_replace( a.MSISDN,"^(237)+(?!$)",""))= b.ACCESS_KEY
