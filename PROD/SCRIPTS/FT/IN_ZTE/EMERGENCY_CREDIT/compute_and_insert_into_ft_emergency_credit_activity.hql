...
INNER JOIN (SELECT * FROM MON.FT_EMERGENCY_CREDIT_ACTIVITY WHERE EVENT_DATE = DATE_SUB('###SLICE_VALUE###',1)) b
ON a.MSISDN=b.MSISDN AND a.ACTIVATION_DATE = b.ACTIVATION_DATE
UNION
SELECT a.*
FROM  MON.TT_EMERGENCY_CREDIT_ACTIVITY a
LEFT JOIN (SELECT DISTINCT MSISDN, ACTIVATION_DATE FROM MON.FT_EMERGENCY_CREDIT_ACTIVITY WHERE EVENT_DATE = DATE_SUB('###SLICE_VALUE###',1) )b ON  a.MSISDN=b.MSISDN AND a.ACTIVATION_DATE = b.ACTIVATION_DATE
