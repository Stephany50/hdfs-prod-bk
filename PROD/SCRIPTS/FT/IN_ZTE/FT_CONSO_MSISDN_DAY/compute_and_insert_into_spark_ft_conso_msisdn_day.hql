...
SELECT
    ...
    SELECT
        ...
        'IT_CRA_ICC_TRADUIT' SRC_TABLE
         ...
         --ONNET
         , SUM (CASE WHEN SERVICE_CODE IN ('NVX_SMS') AND DEST_OPERATOR IN ('OUT_NAT_MOB_OCM') THEN EVENT_COUNT ELSE 0 END ) ONNET_SMS_COUNT
         ...
         , SUM (CASE WHEN SERVICE_CODE IN ('NVX_SMS') AND DEST_OPERATOR IN ('OUT_ROAM_MO') THEN EVENT_COUNT ELSE 0 END ) ROAM_SMS_COUNT
         ...
         , SUM (CASE WHEN SERVICE_CODE IN ('NVX_SMS') AND DEST_OPERATOR IN ('OUT_NAT_MOB_MVO') THEN EVENT_COUNT ELSE 0 END ) SET_SMS_COUNT
         ...
         , SUM (CASE WHEN SERVICE_CODE IN ('NVX_SMS') AND DEST_OPERATOR IN ('IN_ROAM_MT') THEN EVENT_COUNT ELSE 0 END ) INROAM_SMS_COUNT
