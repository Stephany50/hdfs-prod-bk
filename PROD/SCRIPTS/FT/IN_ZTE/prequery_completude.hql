SELECT IF((T_1.CHECK_FILE_COUNT > 23 AND  T_3.CHECK_FILE_ALL_EXIST AND (T_2.CHECK_FILE_EXIST > 0 OR T_6.CHECK_FILE_ALL_EXIST_AND_TYPE > 0)) AND T_4.MISSING_FILES = 0, 'OK','NOK')
FROM
