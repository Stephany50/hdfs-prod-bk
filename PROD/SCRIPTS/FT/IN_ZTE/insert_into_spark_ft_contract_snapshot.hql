...
SELECT
    ...
    , (CASE WHEN UPPER(ZTE.SUBSCRIBER_TYPE) LIKE '%POSTPAID%' THEN 'POSTPAID' ELSE 'PREPAID' END) OSP_ACCOUNT_TYPE
    ...
    ,(CASE WHEN UPPER(ZTE.SUBSCRIBER_TYPE) LIKE '%POSTPAID%' THEN 'PURE POSTPAID' WHEN UPPER(ZTE.SUBSCRIBER_TYPE) LIKE '%PREPAID%' THEN 'PURE PREPAID' ELSE 'HYBRID' END) OSP_CONTRACT_TYPE
