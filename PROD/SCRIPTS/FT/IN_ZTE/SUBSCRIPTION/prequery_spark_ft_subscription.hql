SELECT IF(T_1.FT_EXIST = 0 and T_2.PROD_SPEC_EXTRACT_EXIST>0 and T_3.PRICE_PLAN_EXTRACT_EXIST>0
 and OM > 0
,"OK","NOK") EXTRACT_EXIST
FROM
...
(select count(*) OM from cdr.spark_it_omny_transactions where transfer_datetime='###SLICE_VALUE###') T_4
