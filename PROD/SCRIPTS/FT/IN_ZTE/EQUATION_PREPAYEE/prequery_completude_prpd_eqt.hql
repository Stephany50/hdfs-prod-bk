SELECT IF( (A.CHECK_FILE_COUNT >=24 and B.CHECK_FILE_ALL_EXIST > 0) AND T1.MISSING_FILES = 0 AND T2.MISSING_FILES = 0 AND T3.MISSING_FILES = 0 AND T4.MISSING_FILES = 0 AND T5.MISSING_FILES = 0 AND T6.MISSING_FILES = 0 AND T7.MISSING_FILES = 0 AND T8.MISSING_FILES = 0 AND T9.MISSING_FILES = 0 AND T10.MISSING_FILES = 0 AND T11.MISSING_FILES = 0 , 'OK','NOK') COMPLETUDE
FROM
