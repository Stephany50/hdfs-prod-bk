SELECT IF(VOICE_EXIST>0 and DATA_EXIST>0 and ADJUSTMENT_EXIST>0 and RECHARGE_EXIST>0 and SUBSCRIPTION_EXIST>0
    and TRANSFER_EXIST>0 and ED_EXIST>0 and EC_EXIST>0 and (DELEXPBAL_EXIST>0 or '###SLICE_VALUE###'='2021-11-17' )and IF(BALRESET_EXIST >0, TRUE, IF(MISSING_BALRESET=0, TRUE, FALSE)) and RECURRING_EXIST>0 and PRICE_PLAN_EXIST>0  ,"OK","NOK") TABLES_EXIST
