SELECT IF(T.FT_EXIST = 0 and VOICE_EXIST>0 and DATA_EXIST>0 and ADJUSTMENT_EXIST>0 and RECHARGE_EXIST>0 and SUBSCRIPTION_EXIST>0
    and TRANSFER_EXIST>0 and ED_EXIST>0 and EC_EXIST>0  and DEL_EXPBAL_EXIST >0 and BAL_RESET_EXIST>0 and RECURRING_EXIST>0 and PRICE_PLAN_EXIST>0 ,"OK","NOK") TABLES_EXIST
FROM
