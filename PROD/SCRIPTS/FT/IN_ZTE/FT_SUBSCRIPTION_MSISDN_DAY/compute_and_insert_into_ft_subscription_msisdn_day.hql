 INSERT INTO FT_SUBSCRIPTION_MSISDN_DAY PARTITION(EVENT_DATE)
        ( 
        MSISDN, CUSTOMER_PROFILE, CONTRACT_TYPE, TOTAL_SUBS_COUNT, TOTAL_SUBS_AMOUNT, VOICE_BUNDLE_COUNT, VOICE_BUNDLE_MINUTES
        , VOICE_BUNDLE_AMOUNT, SMS_BUNDLE_COUNT, SMS_BUNDLE_VOLUME, SMS_BUNDLE_AMOUNT, DATA_BUNDLE_COUNT, DATA_BUNDLE_BYTES, DATA_BUNDLE_AMOUNT
        , VOI_DAT_SMS_BUN_COUNT, VOI_DAT_SMS_BUN_AMOUNT, VOI_SMS_BUN_COUNT, VOI_SMS_BUN_AMOUNT, VOI_DAT_BUN_COUNT, VOI_DAT_BUN_AMOUNT
        , DAT_SMS_BUN_COUNT, DAT_SMS_BUN_AMOUNT, OTHER_SUBS_COUNT, OTHER_SUBS_AMOUNT, SRC_TABLE, OPERATOR_CODE, INSERT_DATE,AMOUNT_VOICE_ONNET,
        AMOUNT_VOICE_OFFNET,AMOUNT_VOICE_INTER,AMOUNT_VOICE_ROAMING,AMOUNT_SMS_ONNET,AMOUNT_SMS_OFFNET,AMOUNT_SMS_INTER,AMOUNT_SMS_ROAMING,
        AMOUNT_DATA,AMOUNT_SVA,EVENT_DATE
        )
        SELECT 
        ...
        EVENT_DATE
        FROM MON.FT_SUBSCRIPTION WHERE TRANSACTION_DATE = '###SLICE_VALUE###'
