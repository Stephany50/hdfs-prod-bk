INSERT INTO MON.FT_AMN_LOCAL_TRAFFIC_DAY
        SELECT
		SITE_NAME,
        ...
        (
            ...
            (
                ...
                (
                    ...
                    FROM (SELECT * FROM MON.FT_MSC_TRANSACTION) C JOIN (SELECT ci, lac, site_name FROM dim.dt_gsm_cell_code  WHERE categorie_site LIKE '%AMN%') b
