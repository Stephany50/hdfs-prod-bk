...
FROM
	...
	LEFT JOIN (SELECT FN_FORMAT_MSISDN_TO_9DIGITS(MSISDN) MSISDN9, * FROM   TMP.FT_OG_IC_CALL_SNAPSHOT
...
FROM
	...
	LEFT JOIN (SELECT FN_FORMAT_MSISDN_TO_9DIGITS(MSISDN)MSISDN9,* FROM  TMP.FT_OG_IC_CALL_SNAPSHOT WHERE EVENT_DATE = '###SLICE_VALUE###'  ) b  ON (a.MSISDN = b.MSISDN9)
