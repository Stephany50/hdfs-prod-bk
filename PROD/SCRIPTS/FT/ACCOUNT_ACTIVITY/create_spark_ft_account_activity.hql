CREATE TABLE MON.SPARK_FT_ACCOUNT_ACTIVITY (
...
alter table MON.SPARK_FT_ACCOUNT_ACTIVITY add columns (location_ci varchar(50))
...
to_date(EVENT_DATE)
from backup_dwh.spark_ft_account_activity_20190923