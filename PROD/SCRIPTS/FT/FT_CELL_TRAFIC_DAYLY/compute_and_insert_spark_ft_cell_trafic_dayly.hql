...
, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'OCM_SHORT' and a.CALL_TYPE = 'Entrant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) <> 'SMS' THEN 1 ELSE 0 END) NBRE_TEL_OCM_SHORT_ENTRANT
, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'OCM_SHORT' and a.CALL_TYPE = 'Sortant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) = 'SMS' THEN 1 ELSE 0 END) NBRE_SMS_OCM_SHORT_SORTANT
, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'OCM_SHORT' and a.CALL_TYPE = 'Entrant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) <> 'SMS' THEN DURATION ELSE 0 END) DUREE_TEL_OCM_SHORT_ENTRANT
, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'OCM_SHORT' and a.CALL_TYPE = 'Sortant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) <> 'SMS' THEN DURATION ELSE 0 END) DUREE_TEL_OCM_SHORT_SORTANT

, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'SET' and a.CALL_TYPE = 'Entrant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) <> 'SMS' THEN 1 ELSE 0 END) NBRE_TEL_SET_ENTRANT
, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'SET' and a.CALL_TYPE = 'Sortant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) = 'SMS' THEN 1 ELSE 0 END) NBRE_SMS_SET_SORTANT
, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'SET' and a.CALL_TYPE = 'Entrant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) <> 'SMS' THEN DURATION ELSE 0 END) DUREE_TEL_SET_ENTRANT
, SUM (CASE WHEN FN_NNP_SIMPLE_DESTINATION(a.PARTNER_GT) = 'SET' and a.CALL_TYPE = 'Sortant' AND SUBSTR(TRANSACTION_TYPE, 1, 3) <> 'SMS' THEN DURATION ELSE 0 END) NBRE_TEL_SET_SORTANT
