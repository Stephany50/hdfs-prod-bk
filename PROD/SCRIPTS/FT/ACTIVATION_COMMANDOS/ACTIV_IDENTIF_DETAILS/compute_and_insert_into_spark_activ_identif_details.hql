...
SELECT
    ...
    a.MSISDN_IDENTIFIED,
    CASE 
        WHEN b.ACTIVATED_MSISDN IS NOT NULL THEN 1 
        ELSE 0 
    END AS EST_ACTIVES,
    (
        CASE 
            WHEN b.DATE_ACTIVATION = to_date(a.DATE_IDENTIFICATION) AND 
                b.FIRST_DAY_REFILL = b.DATE_ACTIVATION AND 
                b.ACTIVATED_MSISDN IS NOT NULL THEN 1 
            ELSE 0 
        END
    ) AS EST_SUPER_ACTIVATION,
    (
        CASE
            ...
            ELSE 0 
        END
    ) AS EST_BONNES_ACTIVATION,
    (
        CASE 
            WHEN b.DATE_ACTIVATION IS NULL THEN 1 
            ELSE 0 
        END
    ) AS EST_BAD_ACTIVATION,
    (
        CASE 
            WHEN b.DATE_ACTIVATION IS NOT NULL AND
            (
    ...
    (
        CASE 
            WHEN b.DATE_ACTIVATION IS NOT NULL AND 
                b.REFILL_AMOUNT >= 250 AND 
                b.ACTIVATED_MSISDN IS NOT NULL THEN 1 
            ELSE 0 
        END
    ) AS EST_ACTIVATION_RECH_SUP_250,
    (
        CASE 
    ...
    (
        CASE 
            ...
            ELSE 0 
        END
    ) AS EST_ACTIVES_SNAP_RECH_SUP_250,
