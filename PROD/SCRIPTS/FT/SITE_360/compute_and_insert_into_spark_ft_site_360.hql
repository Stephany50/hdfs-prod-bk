...
(
    ...
    (
        SELECT
            E0.LOCATION_CI  CI
            ,NVL(SUM (CASE WHEN E0.SERVICE_CODE = 'VOI_VOX' THEN  MAIN_RATED_AMOUNT  ELSE  0    END ), 0)  AS TOTAL_VOICE_REVENUE
            ,NVL(SUM (CASE WHEN (MAIN_RATED_AMOUNT) > 0 THEN  DURATION   ELSE  0    END), 0)  TOTAL_VOICE_DURATION
            ,NVL(SUM (CASE WHEN E0.SERVICE_CODE = 'NVX_SMS' THEN  ( MAIN_RATED_AMOUNT)   ELSE  0    END ), 0)  TOTAL_SMS_REVENUE
            ...
            , NVL(SUM (CASE WHEN DEST_OPERATOR IN ('OUT_NAT_MOB_MTN')  THEN (MAIN_RATED_AMOUNT)  ELSE 0 END ), 0) MAIN_RATED_TEL_MTN_AMOUNT
            , NVL(SUM (CASE WHEN DEST_OPERATOR IN ('OUT_NAT_MOB_CAM')  THEN (MAIN_RATED_AMOUNT)  ELSE 0 END ), 0) MAIN_RATED_TEL_CAMTEL_AMOUNT
            , NVL(SUM (CASE WHEN DEST_OPERATOR IN ('OUT_NAT_MOB_NEX')  THEN (MAIN_RATED_AMOUNT)  ELSE 0 END ), 0) MAIN_RATED_TEL_NEXTTEL_AMOUNT
            , NVL(SUM (CASE WHEN DEST_OPERATOR IN ('OUT_NAT_MOB_OCM')  THEN (MAIN_RATED_AMOUNT)  ELSE 0 END ), 0) MAIN_RATED_TEL_OCM_AMOUNT
            , NVL(SUM (CASE WHEN DEST_OPERATOR IN ('OUT_NAT_MOB_MVO')  THEN (MAIN_RATED_AMOUNT)  ELSE 0 END ), 0) MAIN_RATED_TEL_SET_AMOUNT
        FROM
        (
            SELECT
                E00.LOCATION_CI
