...
(
    ...
    (
        SELECT
            ...
            , SUM(NVL(BUNDLE_BYTES_USED_VOLUME, 0))/1024/1024/1000000 DATA_BYTES_USED_IN_BUNDLE
            ...
            , SUM(CASE WHEN NVL(ROAMING_INDICATOR, 0) = 1 THEN NVL(BYTES_SENT, 0) + NVL(BYTES_RECEIVED, 0) - NVL(BUNDLE_BYTES_USED_VOLUME, 0) ELSE 0 END)/1024/1024/1000000 DATA_BYTES_USED_OUT_BUNDLE_ROAM
