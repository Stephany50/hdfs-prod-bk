SELECT IF(
    ...
    AND T_5.ft_client_cell_traffic_hour_EXIST > 1
...
FROM
(SELECT COUNT(*) FT_SITE_360_EXIST FROM MON.SPARK_FT_SITE_360_V2 WHERE EVENT_DATE='###SLICE_VALUE###') T_1,
...
(SELECT COUNT(*) ft_client_cell_traffic_hour_EXIST FROM MON.spark_ft_client_cell_traffic_hour WHERE EVENT_DATE='###SLICE_VALUE###') T_5,
