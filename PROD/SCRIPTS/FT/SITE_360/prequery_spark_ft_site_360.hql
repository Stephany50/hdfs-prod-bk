SELECT IF(
    ...
    AND T_16.FT_COMMERCIAL_SUBSCRIB_SUMMARY_COUNT > 1
    AND T_17.FT_GROUP_SUBSCRIBER_SUMMARY_COUNT > 1
...
(SELECT COUNT(*) FT_COMMERCIAL_SUBSCRIB_SUMMARY_COUNT FROM MON.SPARK_FT_COMMERCIAL_SUBSCRIB_SUMMARY WHERE datecode=date_add('###SLICE_VALUE###', 1)) T_16,
(SELECT COUNT(*) FT_GROUP_SUBSCRIBER_SUMMARY_COUNT FROM MON.SPARK_FT_GROUP_SUBSCRIBER_SUMMARY WHERE event_date=date_add('###SLICE_VALUE###', 1)) T_17
