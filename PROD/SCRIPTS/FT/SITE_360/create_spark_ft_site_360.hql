...
(
    TECHNO_SITE_2G VARCHAR(5),
    TECHNO_SITE_3G VARCHAR(5),
    TECHNO_SITE_4G VARCHAR(5),
    TECHNO_SITE_4GP VARCHAR(5),
    TECHNO_SITE_5G VARCHAR(5),
    ...
    RATED_CALL_DURATION_2G DECIMAL(17, 2),
    RATED_CALL_DURATION_3G DECIMAL(17, 2),
    RATED_CALL_DURATION_4G DECIMAL(17, 2),
    ...
    OG_SMS_TOTAL_2G BIGINT,
    OG_SMS_TOTAL_3G BIGINT,
    OG_SMS_TOTAL_4G BIGINT,

    DATA_BYTES_RECEIVED BIGINT,
    DATA_BYTES_SENT BIGINT,
    DATA_BYTES_RECEIVED_2G BIGINT,
    DATA_BYTES_SENT_2G BIGINT,
    DATA_BYTES_RECEIVED_3G BIGINT,
    DATA_BYTES_SENT_3G BIGINT,
    DATA_BYTES_RECEIVED_4G BIGINT,
    DATA_BYTES_SENT_4G BIGINT,
