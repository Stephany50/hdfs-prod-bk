...
(
    ...
    OG_RATED_CALL_DURATION DECIMAL(17, 2), --okay
    OG_TOTAL_CALL_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_OCM_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_MTN_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_NEXTTEL_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_CAMTEL_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_SET_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_ROAM_IN_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_ROAM_OUT_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_SVA_DURATION DECIMAL(17, 2), --okay
    RATED_TEL_INT_DURATION DECIMAL(17, 2), --okay

    OG_SMS_TOTAL_COUNT BIGINT,  --okay
    OG_SMS_OCM_COUNT BIGINT, --okay
    OG_SMS_MTN_COUNT BIGINT, --okay
    OG_SMS_NEXTTEL_COUNT BIGINT, --okay
    OG_SMS_CAMTEL_COUNT BIGINT, --okay
    OG_SMS_SET_COUNT BIGINT, --okay
    OG_SMS_ROAM_IN_COUNT BIGINT, --okay
    OG_SMS_ROAM_OUT_COUNT BIGINT, --okay
    OG_SMS_SVA_COUNT BIGINT, --okay
    OG_SMS_INTERNATIONAL_COUNT BIGINT, --okay
