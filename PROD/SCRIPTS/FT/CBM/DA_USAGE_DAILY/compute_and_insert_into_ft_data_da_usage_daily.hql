...
MERGE INTO MON.TT_DATA_DA_USAGE_DAILY AS a
...
MERGE INTO MON.TT_DATA_DA_USAGE_DAILY AS a
USING DIM.DT_RATING_EVENT AS  b ON b.RATING_EVENT_ID = a.SERVICE_ZONE
WHEN MATCHED  THEN UPDATE SET SERVICE_ZONE = UPPER(b.RATING_EVENT_NAME)
...
MERGE INTO MON.TT_DATA_DA_USAGE_DAILY AS a
USING DIM.DT_RATING_SERVICE_GROUP AS  b ON b.RATING_GROUP_ID = a.SERVICE_TYPE
WHEN MATCHED  THEN UPDATE SET SERVICE_TYPE = UPPER(b.RATING_SERVICE_TYPE)

;

INSERT  INTO MON.FT_DATA_DA_USAGE_DAILY PARTITION(SESSION_DATE)
SELECT * FROM MON.TT_DATA_DA_USAGE_DAILY
