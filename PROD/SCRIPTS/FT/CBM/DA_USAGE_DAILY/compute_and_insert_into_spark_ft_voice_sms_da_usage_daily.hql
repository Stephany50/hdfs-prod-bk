INSERT INTO MON.SPARK_FT_VOICE_SMS_DA_USAGE_DAILY
SELECT
        MSISDN,
        IF(DT_BALANCE_TYPE_ITEM.ACCT_ITEM_TYPE_ID IS NULL,SPARK_TT_VOICE_SMS_DA_USAGE_DAILY.DA_NAME,UPPER(DT_BALANCE_TYPE_ITEM.ACCT_RES_NAME)) DA_NAME,
        IF(DT_BALANCE_TYPE_ITEM.ACCT_ITEM_TYPE_ID IS NULL,SPARK_TT_VOICE_SMS_DA_USAGE_DAILY.DA_UNIT,UPPER(DT_BALANCE_TYPE_ITEM.ACCT_RES_RATING_UNIT)) DA_UNIT,
        IF(DT_BALANCE_TYPE_ITEM.ACCT_ITEM_TYPE_ID IS NULL,SPARK_TT_VOICE_SMS_DA_USAGE_DAILY.DA_TYPE,UPPER(DT_BALANCE_TYPE_ITEM.ACCT_RES_RATING_TYPE)) DA_TYPE,
        ...
        OTHER_PARTY_ZONE,
        DESTINATION,
        SPARK_TT_VOICE_SMS_DA_USAGE_DAILY.USAGE,
...
FROM (
    ...
    GROUP BY TRANSACTION_DATE,
        ...
        DESTINATION,
        USAGE
)SPARK_TT_VOICE_SMS_DA_USAGE_DAILY
LEFT JOIN DIM.DT_BALANCE_TYPE_ITEM  DT_BALANCE_TYPE_ITEM ON  DT_BALANCE_TYPE_ITEM.ACCT_ITEM_TYPE_ID = SPARK_TT_VOICE_SMS_DA_USAGE_DAILY.DA_NAME