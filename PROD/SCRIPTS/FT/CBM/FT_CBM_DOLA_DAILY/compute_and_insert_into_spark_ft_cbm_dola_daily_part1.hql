INSERT INTO TMP.SPARK_TT_FT_CBM_DOLA_DAILY_PRE (MSISDN, DOLA, ACTIVITY_TYPE)
...
UNION ALL  
    --INSERTION RECHARGE 
    SELECT SUBSTR(ACC_NBR,-9)MSISDN, TO_DATE(PAY_TIME) DOLA,'RECHARGE' ACTIVITY_TYPE FROM CDR.SPARK_IT_ZTE_RECHARGE
