INSERT INTO TMP.SPARK_TT_FT_CBM_DOLA_DAILY_PRE
SELECT
    '###SLICE_VALUE###' EVENT_DATE,
    SERVED_PARTY MSISDN,
    TRANSACTION_DATE DOLA,
    SERVICE_CODE ACTIVITY_TYPE
...
SELECT
    '###SLICE_VALUE###' EVENT_DATE,
    SUBSTR(ACC_NBR,-9) MSISDN,
    TO_DATE(PAY_TIME) DOLA,
    'RECHARGE' ACTIVITY_TYPE 
