CREATE TABLE MON.SPARK_FT_CBM_ARPU_MOU(
msisdn   VARCHAR(255),
arpu   VARCHAR(255),
...
ALTER TABLE MON.SPARK_FT_CBM_ARPU_MOU ADD COLUMNS (BYTES_DATA DECIMAL(17, 2));
ALTER TABLE MON.SPARK_FT_CBM_ARPU_MOU ADD COLUMNS (FOU_SMS BIGINT);
ALTER TABLE MON.SPARK_FT_CBM_ARPU_MOU ADD COLUMNS (VOLUME_4G VARCHAR(255));
ALTER TABLE MON.SPARK_FT_CBM_ARPU_MOU ADD COLUMNS (VOLUME_3G VARCHAR(255));
ALTER TABLE MON.SPARK_FT_CBM_ARPU_MOU ADD COLUMNS (VOLUME_2G VARCHAR(255));
