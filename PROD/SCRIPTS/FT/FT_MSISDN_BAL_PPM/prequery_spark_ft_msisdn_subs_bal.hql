SELECT IF(
    T_1.FT_EXIST = 0 
    and T_2.PROD_SPEC_EXTRACT_EXIST>0 
    and T_3.PRICE_PLAN_EXTRACT_EXIST>0
    , "OK"
    ,"NOK"
) EXTRACT_EXIST
FROM
(SELECT COUNT(*) FT_EXIST FROM MON.spark_ft_msisdn_subs_bal WHERE event_date='###SLICE_VALUE###') T_1,
