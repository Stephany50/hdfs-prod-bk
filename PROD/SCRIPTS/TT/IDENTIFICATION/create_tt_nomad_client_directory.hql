CREATE EXTERNAL TABLE IF NOT EXISTS CDR.TT_NOMAD_CLIENT_DIRECTORY (
...
COMMENT 'TT_NOMAD_CLIENT_DIRECTORY external tables-TT'
ROW FORMAT DELIMITED FIELDS TERMINATED BY ';'
LOCATION '/PROD/TT/IDENTIFICATION/NOMAD_PROD'
