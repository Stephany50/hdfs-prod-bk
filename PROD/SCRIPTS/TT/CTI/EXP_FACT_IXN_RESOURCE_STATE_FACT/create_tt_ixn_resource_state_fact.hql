...
CREATE EXTERNAL TABLE IF NOT EXISTS CTI.TT_IXN_RESOURCE_STATE_FACT (
...
COMMENT 'TT_IXN_RESOURCE_STATE_FACT '
ROW FORMAT DELIMITED FIELDS TERMINATED BY ';'
LOCATION '/PROD/TT/CTI/EXP_FACT_IXN_RESOURCE_STATE_FACT'
