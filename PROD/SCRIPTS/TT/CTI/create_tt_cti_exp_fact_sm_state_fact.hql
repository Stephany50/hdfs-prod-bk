CREATE EXTERNAL TABLE IF NOT EXISTS CTI.TT_EXP_FACT_SM_RES_STATE_FACT (
...
PRIMARY_MEDIA_RESOURCE_KEY VARCHAR(50),
...
COMMENT 'CTI EXP_FACT_SM_RES_STATE_FACT'
ROW FORMAT DELIMITED FIELDS TERMINATED BY ';'
LOCATION '/PROD/RAW/CTI/EXP_FACT_SM_RES_STATE_FACT'
