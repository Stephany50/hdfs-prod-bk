...
FROM
(SELECT COUNT(distinct event_date) nb_dates FROM AGG.SPARK_FT_A_REVENU_SITE_NURAN WHERE EVENT_DATE between date_sub('###SLICE_VALUE###', 7) and date_sub('###SLICE_VALUE###', 1)) T_1,
