...
nvl(trim(replace(addresse,';',' ')),'') as addresse,
nvl(trim(replace(quartier,';',' ')),'') as quartier,
nvl(trim(replace(ville,';',' ')),'') as ville,
nvl(trim(replace(statut_bscs,';',' ')),'') as statut_bscs,
...
nvl(trim(replace(numero_piece_rep_legal,';',' ')),'') as numero_piece_rep_legal,
...
nvl(trim(replace(nom_parent,';',' ')),'') as nom_parent,
