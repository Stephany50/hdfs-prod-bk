...
FROM
(SELECT COUNT(distinct event_date) nb_dates FROM mon.spark_ft_amn_local_traffic_day2 WHERE EVENT_DATE between date_sub('###SLICE_VALUE###', 7) and date_sub('###SLICE_VALUE###', 1)) T_1,
