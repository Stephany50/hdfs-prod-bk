SELECT IF( T_1.AGG_EXIST > 0 AND T_2.NB_EXPORT < 1 ,"OK","NOK")
FROM
(SELECT COUNT(*) AGG_EXIST FROM AGG.SPARK_FT_FMS_QOS_SMSC_SPECIAL_NUMBER WHERE STATE_DATE ='###SLICE_VALUE###') T_1,
