select
    ...
    (
        T5.SCORE_AGE + 
        T5.SCORE_AVERAGE_CALLS_ON_D + 
        T5.SCORE_AVERAGE_CALLS_ON_N +
        T5.SCORE_AVERAGE_DEPOSIT_AMT_1M_3M + 
        T5.SCORE_AVERAGE_DEPOSIT_AMT_4M_6M +
        T5.SCORE_INCOME_STREAM_1M +
        T5.SCORE_INCOME_STREAM_2M +
        T5.SCORE_INCOME_STREAM_3M +
        T5.SCORE_AVERAGE_INCOME_STREAM +
        T5.SCORE_OM_EXPERIENCE +
        T5.SCORE_ON_TO_OFF_CALLS + 
        T5.SCORE_SUBS_EXPERIENCE +
        T5.SCORE_AVERAGE_ATC_LOANS_QTY_1M_6M
    ) SCORE
from
(
    select
