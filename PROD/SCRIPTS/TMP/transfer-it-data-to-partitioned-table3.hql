...
SELECT
    ...
    select
        ...
        current_timestamp insert_date,
        current_date processing_date
    from (select cast(sum(rated_amount) as bigint) parcj0 from  AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date= date_sub('2020-04-29',7)   and KPI='PARC' and DESTINATION_CODE = 'USER_GROUP' )a,
     (select cast(sum(rated_amount) as bigint) parcj7 from AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date= '2020-04-29'    and KPI='PARC' and DESTINATION_CODE = 'USER_GROUP')b
  --  left join dim.spark_dt_regions_mkt_v2 b on a.region_id = b.region_id
  --  where transaction_date between date_sub('2020-04-29',7) and  '2020-04-29'   and KPI='PARC' and DESTINATION_CODE = 'USER_CHURN'
   ...
   UNION ALL
    ...
    select
        ...
        current_timestamp insert_date,
        current_date processing_date
    from (select sum(rated_amount) rated_amount from AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date between date_sub('2020-04-29',7) and  '2020-04-29'   and KPI= 'REFILL_SELF_TOP') a,
     (select sum(rated_amount) rated_amount  from AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date between date_sub('2020-04-29',7) and  '2020-04-29'   and KPI= 'VALEUR_AIRTIME')  b
    --left join dim.spark_dt_regions_mkt_v2 b on a.region_id = b.region_id
   ...
   UNION ALL
    ...
    select
        ...
        current_timestamp insert_date,
        current_date processing_date
    from (select sum(rated_amount) rated_amount from AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date between date_sub('2020-04-29',7) and  '2020-04-29'   and KPI= 'SNAPSHOT_STOCK_DIST') a,
     (select sum(rated_amount)  rated_amount from AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date between date_sub('2020-04-29',7) and  '2020-04-29'   and KPI= 'AVG_REFILL_DIST') b
   -- left join dim.spark_dt_regions_mkt_v2 b on a.region_id = b.region_id
  ...
  --  group by
   ...
   -- source_table
    ...
    select
        ...
        current_timestamp insert_date,
        current_date processing_date
    from (select sum(rated_amount) rated_amount from AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date between date_sub('2020-04-29',7) and  '2020-04-29'   and KPI= 'SNAPSHOT_STOCK_CLIENT') a,
     (select sum(rated_amount)  rated_amount from AGG.SPARK_FT_GLOBAL_ACTIVITY_DAILY_MKT_DG where transaction_date between date_sub('2020-04-29',7) and  '2020-04-29'   and KPI= 'AVG_REFILL_CLIENT') b
   -- left join dim.spark_dt_regions_mkt_v2 b on a.region_id = b.region_id
--    group by
   -- b.administrative_region ,
  --  b.commercial_region,
