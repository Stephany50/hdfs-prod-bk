SELECT  IF(T_1.SMS_EXISTS = 0 AND T_2.FT_GROUP_SUBSCRIBER_SUMMARY_OK>=1 AND T_3.FT_GROUP_SUBSCRIBER_SUMMARY_PRE_OK >=1 AND T_4.FT_A_SUBSCRIBER_SUMMARY_OK >=1 AND T_5.FT_COMMERCIAL_SUBSCRIB_SUMMARY_OK >=1,"OK","NOK") REVENUE_EXISTS
FROM
