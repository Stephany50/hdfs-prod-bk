...
UNION ALL
SELECT 'FT' table_type , 'MSC/IN' table_source, 'FT_CBM_DOLA_DAILY' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.FT_CBM_DOLA_DAILY WHERE EVENT_DATE='###SLICE_VALUE###'
UNION ALL
...
UNION ALL
SELECT 'FT' table_type , 'MSC/IN' table_source, 'FT_COMMERCIAL_SUBSCRIB_SUMMARY' TABLE_NAME, COUNT(*) NB_ROWS, MAX(refresh_date) TABLE_INSERT_DATE  FROM MON.FT_COMMERCIAL_SUBSCRIB_SUMMARY WHERE DATECODE='###SLICE_VALUE###'
UNION ALL
...
UNION ALL
SELECT 'FT' table_type , 'MSC/IN' table_source, 'FT_PDM_TRANSACTION' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.FT_PDM_TRANSACTION WHERE EVENT_DATE='###SLICE_VALUE###'
UNION ALL
SELECT 'FT' table_type , 'MSC/IN' table_source, 'FT_PDM_TRANSACTION_OTHER' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.FT_PDM_TRANSACTION_OTHER WHERE EVENT_DATE='###SLICE_VALUE###'
UNION ALL
...
UNION ALL
SELECT 'FTA' table_type , 'MSC/IN' table_source, 'FT_A_SUBSCRIBER_SUMMARY' TABLE_NAME, COUNT(*) NB_ROWS, MAX(refresh_date) TABLE_INSERT_DATE  FROM AGG.FT_A_SUBSCRIBER_SUMMARY WHERE datecode='###SLICE_VALUE###'
UNION ALL
