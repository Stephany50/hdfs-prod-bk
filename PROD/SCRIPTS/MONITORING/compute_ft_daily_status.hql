...
UNION ALL
SELECT 'FTA' table_type , 'MSC/IN' table_source, 'FT_A_REFILL_RECEIVER' TABLE_NAME, COUNT(*) NB_ROWS, MAX(last_update) TABLE_INSERT_DATE  FROM AGG.FT_A_REFILL_RECEIVER WHERE TO_DATE(last_update)='###SLICE_VALUE###'
UNION ALL
