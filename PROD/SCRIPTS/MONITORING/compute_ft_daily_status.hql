...
SELECT 'FTA' table_type , 'MSC/IN' table_source, 'FT_A_GPRS_LOCATION' TABLE_NAME, COUNT(*) NB_ROWS, MAX(last_update) TABLE_INSERT_DATE  FROM AGG.FT_A_GPRS_LOCATION WHERE session_date='###SLICE_VALUE###'
UNION ALL
