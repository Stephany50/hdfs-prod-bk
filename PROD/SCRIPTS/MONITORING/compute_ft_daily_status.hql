...
UNION ALL
SELECT 'FT' table_type , 'MSC/IN' table_source, 'FT_IMEI_ONLINE' TABLE_NAME, COUNT(*) NB_ROWS, MAX(SDATE) TABLE_INSERT_DATE  FROM MON.FT_IMEI_ONLINE WHERE TO_DATE(SDATE)='###SLICE_VALUE###'
