...
LEFT JOIN (SELECT DISTINCT  ORIGINAL_FILE_NAME FROM CDR.IT_ZTE_ADJUSTMENT B WHERE CREATE_DATE ='2019-05-08' and TO_DATE(ORIGINAL_FILE_DATE) = '2019-05-08') B ON B.ORIGINAL_FILE_NAME = C.FILE_NAME
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
...
LEFT JOIN (SELECT DISTINCT ORIGINAL_FILE_NAME FROM CDR.IT_ZTE_RECHARGE B WHERE PAY_DATE = '2019-05-08' and TO_DATE(ORIGINAL_FILE_DATE) = '2019-05-08') B ON B.ORIGINAL_FILE_NAME = C.FILE_NAME
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
