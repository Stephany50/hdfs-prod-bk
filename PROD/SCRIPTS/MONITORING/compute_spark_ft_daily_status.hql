...
UNION ALL
SELECT 'FT' table_type , 'OM' table_source, 'FT_DATAMART_OM_DAILY' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.SPARK_FT_DATAMART_OM_DAILY WHERE PERIOD='###SLICE_VALUE###'
UNION ALL
SELECT 'FT' table_type , 'OM' table_source, 'FT_OMNY_ACCOUNT_SNAPSHOT' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.SPARK_FT_OMNY_ACCOUNT_SNAPSHOT WHERE EVENT_DATE='###SLICE_VALUE###'
) T
