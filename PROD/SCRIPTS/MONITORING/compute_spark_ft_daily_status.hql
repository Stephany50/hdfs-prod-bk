...
UNION ALL
SELECT 'FT' table_type , 'FT' table_source, 'FT_ACTIVATIONS_LOCATION' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.SPARK_FT_ACTIVATIONS_LOCATION WHERE ACTIVATION_DATE='###SLICE_VALUE###'
UNION ALL
SELECT 'FT' table_type , 'FT' table_source, 'FT_ACTIVATION_MONTH' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.SPARK_FT_ACTIVATION_MONTH WHERE ACTIVATION_DATE='###SLICE_VALUE###'
UNION ALL
SELECT 'FT' table_type , 'FT' table_source, 'FT_ACTIVATIONS_SITE_DAY' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.SPARK_FT_ACTIVATIONS_SITE_DAY WHERE ACTIVATION_DATE='###SLICE_VALUE###'
UNION ALL
SELECT 'FT' table_type , 'FT' table_source, 'FT_PARC_ACTIVATIONS_SITE' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.SPARK_FT_PARC_ACTIVATIONS_SITE WHERE EVENT_DATE='###SLICE_VALUE###'
UNION ALL
