...
UNION ALL
SELECT 'FT' table_type , 'IN' table_source, 'SPARK_FT_MSISDN_RECYCLAGE' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM MON.SPARK_FT_MSISDN_RECYCLAGE WHERE EVENT_DATE='###SLICE_VALUE###'
UNION ALL
SELECT 'FTA' table_type , 'IN' table_source, 'SPARK_FT_A_MSISDN_RECYCLAGE' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM AGG.SPARK_FT_A_MSISDN_RECYCLAGE WHERE EVENT_DATE='###SLICE_VALUE###'
) T
