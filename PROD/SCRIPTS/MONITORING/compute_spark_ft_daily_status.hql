...
UNION ALL
SELECT 'FT' table_type , 'IN' table_source, 'FT_A_CREDIT_TRANSFER_SENDER' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM AGG.SPARK_FT_A_CREDIT_TRANSFER_SENDER WHERE REFILL_DATE='###SLICE_VALUE###'
UNION ALL
