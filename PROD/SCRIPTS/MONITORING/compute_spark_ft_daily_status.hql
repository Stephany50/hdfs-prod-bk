...
UNION ALL
SELECT 'FT' table_type , 'FT' table_source, 'spark_FT_ACTIVATION_BY_IDENTIF_DAY' TABLE_NAME, COUNT(*) NB_ROWS, MAX(INSERT_DATE) TABLE_INSERT_DATE  FROM mon.spark_FT_ACTIVATION_BY_IDENTIF_DAY WHERE activation_date='###SLICE_VALUE###'
