...
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_DATA_CDR' FLUX_NAME, C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_DATA_POST_CDR' FLUX_NAME, C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_VOICE_SMS_CDR' FLUX_NAME,C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_VOICE_SMS_POST_CDR' FLUX_NAME, C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_ADJUSTMENT_CDR' FLUX_NAME,C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_RECHARGE_CDR' FLUX_NAME,C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_TRANSFER_CDR' FLUX_NAME, C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_SUBSCRIPTION_CDR' FLUX_NAME,C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_ED_CDR' FLUX_NAME,C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'IN' TABLE_SOURCE,'ZTE_EC_CDR' FLUX_NAME,C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
...
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
SELECT '2019-05-04' ORIGINAL_FILE_DATE,'ZEBRA' TABLE_SOURCE,'ZEBRA_CDR' FLUX_NAME,C.FILE_NAME FILE_NAME, CURRENT_TIMESTAMP INSERT_DATE
FROM
(
    SELECT
     A.FILE_NAME
