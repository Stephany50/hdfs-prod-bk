...
LEFT JOIN (SELECT DISTINCT ORIGINAL_FILE_NAME FROM CDR.SPARK_IT_BDI B WHERE ORIGINAL_FILE_DATE ='###SLICE_VALUE###') B ON SUBSTRING(B.ORIGINAL_FILE_NAME,5,8) = SUBSTRING(C.FILE_NAME,5,8)
WHERE B.ORIGINAL_FILE_NAME IS NULL
UNION
