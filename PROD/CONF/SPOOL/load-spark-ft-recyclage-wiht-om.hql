...
flux.name = "LOAD_SPARK_SPOOL_RECYCLAGE_OM"
...
flux.pre-exec-queries += "/PROD/SCRIPTS/SPOOL/RECYCLAGE/prequery_spool_recylage_with_om.hql"

flux.exec-queries += "/PROD/SCRIPTS/SPOOL/RECYCLAGE/compute_and_insert_spool_recyclage_om.hql"
...
flux.hdfs.output-path = "/PROD/EXPORT/EXPORT_SPOOL_RECYCLAGE_OM"
